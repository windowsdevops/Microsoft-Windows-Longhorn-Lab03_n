...
GetFileVersionInfoSizeA(
        ...
        __out __opt LPDWORD lpdwHandle       /* Information for use by GetFileVersionInfo */
        );                      
/* Returns size of version info in bytes */
DWORD
APIENTRY
...
VerQueryValueA(
        ...
        __typefix(LPSTR) __out_ecount(*puLen) LPVOID * lplpBuffer,
        __out PUINT puLen
        );
BOOL
APIENTRY
VerQueryValueW(
        ...
        __typefix(LPWSTR) __out_ecount(*puLen) LPVOID * lplpBuffer,
        __out PUINT puLen
        );
#ifdef UNICODE
