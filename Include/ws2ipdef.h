...
//
// TODO: set the correct address for all MLDv2 routers on link. Currently, it
// is the same as all routers on link.
//
#define IN6ADDR_ALLMLDV2ROUTERSONLINK_INIT IN6ADDR_ALLROUTERSONLINK_INIT
...
#define IN6ADDR_LINKLOCALPREFIX_LENGTH 10
...
WS2TCPIP_INLINE
CONST UCHAR*
IN6_GET_ADDR_V4MAPPED(CONST IN6_ADDR *a)
{
    return (CONST UCHAR *)&a->s6_bytes[12];
}
...
typedef struct group_req {
    ...
    struct sockaddr_storage gr_group;  // Multicast address.
