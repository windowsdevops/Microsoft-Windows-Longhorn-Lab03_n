...
WINCOMMDLGAPI short APIENTRY GetFileTitleA(LPCSTR, __out_bcount(cbSize) LPSTR Buf, __in WORD cbSize);
WINCOMMDLGAPI short APIENTRY GetFileTitleW(LPCWSTR, __out_bcount(cbSize) LPWSTR Buf, __in WORD cbSize);
#ifdef UNICODE
