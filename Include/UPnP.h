...
/* [nonextensible][unique][oleautomation][helpstring][uuid][object] */ 
...
EXTERN_C const IID IID_IUPnPAddressFamilyControl;
    ...
    {
    public:
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE SetAddressFamily( 
            /* [in] */ DWORD dwFlags) = 0;
        
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE GetAddressFamily( 
    ...
    typedef struct IUPnPAddressFamilyControlVtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *SetAddressFamily )( 
            IUPnPAddressFamilyControl * This,
            /* [in] */ DWORD dwFlags);
        
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *GetAddressFamily )( 
            IUPnPAddressFamilyControl * This,
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IUPnPAddressFamilyControl_SetAddressFamily_Proxy( 
    IUPnPAddressFamilyControl * This,
    /* [in] */ DWORD dwFlags);


void __RPC_STUB IUPnPAddressFamilyControl_SetAddressFamily_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IUPnPAddressFamilyControl_GetAddressFamily_Proxy( 
    IUPnPAddressFamilyControl * This,
    /* [retval][out] */ DWORD *pdwFlags);


void __RPC_STUB IUPnPAddressFamilyControl_GetAddressFamily_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IUPnPDeviceFinderAddCallbackWithInterface_DeviceAddedWithInterface_Proxy( 
    IUPnPDeviceFinderAddCallbackWithInterface * This,
    /* [in] */ LONG lFindData,
    /* [in] */ IUPnPDevice *pDevice,
    /* [in] */ GUID *pguidInterface);
...
void __RPC_STUB IUPnPDeviceFinderAddCallbackWithInterface_DeviceAddedWithInterface_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
