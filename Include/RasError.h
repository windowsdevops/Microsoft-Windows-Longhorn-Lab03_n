...
//
// This error was obsoleted in the Longhorn release.
//
...
// #if (WINVER < 0x600) bugbug - see 657989
//
...
#define ERROR_VPN_DISCONNECT                 (RASBASE+206)
/*
 * PRELIMINARY ERROR TEXT: The physical connection between you and the VPN server was interrupted.  This can be caused by a problem in the VPN transmission and is commonly the result of internet latency or simply that your VPN server has reached capacity.  Please try to reconnect to the VPN server.  If this problem persists, contact the VPN administrator and analyze the quality of the connection between the two machines.%0
 */

#define ERROR_VPN_BLOCKED                    (RASBASE+207)
/*
 * PRELIMINARY ERROR TEXT: The physical connection between you and the VPN server was established but communications were unable to proceed.  This is typically caused by one of the internet devices between you and server not being properly configured to allow VPN connections to pass through (i.e. firewalls, NAT, router config, etc).  Please get the assistance of your administrator to determine what device might be causing this trouble.%0
 */

#define ERROR_VPN_REFUSED                    (RASBASE+208)
/*
 * PRELIMINARY ERROR TEXT: The physical connection between you and the VPN server was not possible as the server refused the connection.  This is typically caused by the VPN Server's configuration not allowing for your type of VPN connection.  Please contact the administrator of the VPN server and notify them of this error.%0
 */

#define ERROR_VPN_TIMEOUT                    (RASBASE+209)
/*
 * PRELIMINARY ERROR TEXT: The physical connection between you and the VPN server was not possible as the server never responded.  This is typically caused by one of the internet devices between the you and server not being properly configured to allow VPN connections to pass through (i.e. firewalls, NAT, router config, etc).  Please get the assistance of your administrator to determine what device might be causing this trouble.%0
 */

#define ERROR_VPN_BAD_CERT                   (RASBASE+210)
/*
 * PRELIMINARY ERROR TEXT: The physical connection between you and the VPN server was established but communications were unable to proceed.  This is typically caused by a certificate problem between the client and server.  A certificate is used to guarantee you are who you say you are in an IP Security (IPSec) communication cycle.  Please get the assistance of your administrator to determine where the certificate problem is originating.%0
 */

#define ERROR_VPN_BAD_PSK                    (RASBASE+211)
/*
 * PRELIMINARY ERROR TEXT: The physical connection between you and the VPN server was established but communications were unable to proceed.  This is typically caused by a pre-shared key problem between the client and server.  A pre-shared key is used to guarantee you are who you say you are in an IP Security (IPSec) communication cycle.  Please get the assistance of your administrator to determine where the pre-shared key problem is originating.%0
 */

#define ERROR_SERVER_POLICY                  (RASBASE+212)
/*
 * PRELIMINARY ERROR TEXT: The connection was prevented because of a policy utilized by your RAS server.  Specifically, your authentication method, by which your username and password are verified, was denied.  Please contact the administrator of the RAS server and notify them of this error.%0
 */

#define ERROR_BROADBAND_ACTIVE               (RASBASE+213)
/*
 * PRELIMINARY ERROR TEXT: You have attempted to connect a second Broadband Connection has failed.  Please disconnect your first connection and then attempt this connection again.%0
 */

#define ERROR_BROADBAND_NO_NIC               (RASBASE+214)
/*
 * PRELIMINARY ERROR TEXT: You have attempted to connect a Broadband Connection without first having an underlying Ethernet Connection.  Please connect the Ethernet Card first via the Network Connections thingy and then attempt this connection again.%0
 */

#define ERROR_BROADBAND_TIMEOUT              (RASBASE+215)
/*
 * PRELIMINARY ERROR TEXT: The physical connection between you and the Broadband Server was not possible as the server never responded.  This is typically caused by a problem with the 'Service Name' for this connection.one of the internet devices   Some Providers require this value to be blank and others require it to a specific value.  Please contact your Internet Provider and inquire about this value then adjust it in the connection properties.%0
 */
