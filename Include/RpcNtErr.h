...
#endif
#define ERROR_OUTOFMEMORY                   STATUS_NO_MEMORY

#if defined(ERROR_MAX_THRDS_REACHED)
#undef ERROR_MAX_THRDS_REACHED
#endif
#define ERROR_MAX_THRDS_REACHED             STATUS_NO_MEMORY
...
#endif
#define ERROR_INVALID_SECURITY_DESCR        STATUS_INVALID_SECURITY_DESCR

#if defined(ERROR_ACCESS_DENIED)
#undef ERROR_ACCESS_DENIED
#endif
#define ERROR_ACCESS_DENIED                 STATUS_ACCESS_DENIED

#if defined(ERROR_NOACCESS)
#undef ERROR_NOACCESS
#endif
#define ERROR_NOACCESS                      STATUS_ACCESS_VIOLATION
