...
EXTERN_C const IID IID_IPropertyBag2;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE Read( 
            ...
            /* [size_is][in] */ PROPBAG2 *pPropBag,
            /* [size_is][in] */ IErrorLog *pErrLog,
            /* [size_is][out] */ VARIANT *pvarValue,
            /* [size_is][unique][out][in] */ HRESULT *phrError) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE Write( 
            /* [in] */ ULONG cProperties,
            /* [size_is][in] */ PROPBAG2 *pPropBag,
            /* [size_is][in] */ VARIANT *pvarValue) = 0;
    ...
    typedef struct IPropertyBag2Vtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *Read )( 
            ...
            /* [size_is][in] */ IErrorLog *pErrLog,
            /* [size_is][out] */ VARIANT *pvarValue,
            /* [size_is][unique][out][in] */ HRESULT *phrError);
        
        HRESULT ( STDMETHODCALLTYPE *Write )( 
            IPropertyBag2 * This,
            /* [in] */ ULONG cProperties,
            /* [size_is][in] */ PROPBAG2 *pPropBag,
            /* [size_is][in] */ VARIANT *pvarValue);
