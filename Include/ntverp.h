...
#define VER_PRODUCTBUILD            /* NT */   4074
...
/*--------------------------------------------------------------*/
#define VER_DDK_PRODUCTVERSION        6,00
#define VER_DDK_PRODUCTVERSION_STR   "6.00"
...
#if 0
// @@END_DDKSPLIT
#define VER_COMPANYNAME_STR         "Windows (R) .NET 2003 DDK provider"
#define VER_PRODUCTNAME_STR         "Windows (R) .NET 2003 DDK driver"
