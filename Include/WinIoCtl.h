...
#define FSCTL_SET_REPAIR                CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 73, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_GET_REPAIR                CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 74, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_WAIT_FOR_REPAIR           CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 75, METHOD_BUFFERED, FILE_ANY_ACCESS)
#endif /* _WIN32_WINNT >= 0x0500 */
...
#define FSCTL_QUERY_VOLUME_SHRINK_PROGRESS  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 97, METHOD_BUFFERED, FILE_SPECIAL_ACCESS) // VOLUME_EXTEND_PROGRESS
#define FSCTL_SET_SECURE_DELETE             CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 101, METHOD_BUFFERED, FILE_SPECIAL_ACCESS) 
#endif

//
//  Must define these for lower version to build for .NET server
//
#if(_WIN32_WINNT >= 0x0500)
#define FSCTL_TXFS_SET_RM_INFORMATION       CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 81, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_TXFS_QUERY_RM_INFORMATION     CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 82, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_TXFS_FLUSH_AND_CHECKPOINT_RM  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 83, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_TXFS_ROLLFORWARD_REDO         CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 84, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_TXFS_ROLLFORWARD_UNDO         CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 85, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_TXFS_START_RM                 CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 86, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_TXFS_SHUTDOWN_RM              CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 87, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_TXFS_READ_BACKUP_INFORMATION  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 88, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_TXFS_WRITE_BACKUP_INFORMATION CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 89, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_TXFS_CREATE_SECONDARY_RM      CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 90, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_TXFS_GET_METADATA_INFO        CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 91, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_TXFS_GET_TRANSACTED_VERSION   CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 92, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_TXFS_RESIZE_LOG               CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 93, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_TXFS_SAVEPOINT_INFORMATION    CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 94, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_TXFS_CREATE_MINIVERSION		CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 95, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_TXFS_GET_KERNEL_INTERFACES    CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 96, METHOD_BUFFERED, FILE_ANY_ACCESS)
//  97 is FSCTL_QUERY_VOLUME_SHRINK_PROGRESS
#define FSCTL_TXFS_REMOVE_TXF_ID            CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 98, METHOD_BUFFERED, FILE_ANY_ACCESS)
#endif
...
#define FILE_PREFETCH_TYPE_MAX 		 0x3
...
//
// Structures for FSCTL_QUERY_VOLUME_SHRINK_PROGRESS
//

typedef struct _VOLUME_EXTEND_PROGRESS {
    DWORD PercentageDone;
} VOLUME_EXTEND_PROGRESS, *PVOLUME_EXTEND_PROGRESS;
