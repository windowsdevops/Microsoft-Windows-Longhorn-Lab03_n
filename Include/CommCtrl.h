...
#define ICC_HISTOGRAM_CLASS    0x00010000
...
#if (_WIN32_WINNT >= 0x0600)
#define HSTM_FIRST              0x1800      // Histogram control messages
#endif // _WIN32_WINNT >= 0x0600
...
#if (_WIN32_WINNT >= 0x0600)
#define HSTN_FIRST              (0U-1360U)      // Histogram Control
#define HSTN_LAST               (OU-1399U)
#endif
...
#define CDRF_DOERASE            0x00000008 // ;Internal for now; draw the background
#define CDRF_SKIPPOSTPAINT      0x00000100 // ;Internal for now; don't draw the focus rect
...
#define ILS_EMBOSS              0x00000010
#define ILS_REFLECT             0x00000020
#define ILS_INVERT              0x00000040

#define ILS_EFFECTS             0x0000007F
...
#define HDF_HIDDEN           0x1000000 // Column is hidden; same as LVCFMT_HIDDEN
#endif
...
#if (_WIN32_IE >= 0x0501) // change this to 0x502
...
#define TOOLBARCLASSNAME_MILW   L"ToolbarWindow32_Mil"
#define TOOLBARCLASSNAME_MILA   "ToolbarWindow32_Mil"

#ifdef  UNICODE
#define TOOLBARCLASSNAME        TOOLBARCLASSNAMEW
#define TOOLBARCLASSNAME_MIL    TOOLBARCLASSNAME_MILW
#else
#define TOOLBARCLASSNAME        TOOLBARCLASSNAMEA
#define TOOLBARCLASSNAME_MIL    TOOLBARCLASSNAME_MILA
#endif
...
#if (_WIN32_WINNT >= 0x0600)
#define TBSTYLE_EX_CALLBACKIMAGELABELS      0x00000400 // call back for image labels
#endif
...
#if (_WIN32_WINNT >= 0x0600)
#define TBIF_IMAGELABEL         0x00000080 // ink label
#endif
...
#define TBBUTTONINFO_V1_SIZE CCSIZEOF_STRUCT(TBBUTTONINFOW, cchText)
#define TBBUTTONINFO_V2_SIZE CCSIZEOF_STRUCT(TBBUTTONINFOW, iImageLabel)
...
#define HICF_STYLUS         0x00000200          // Triggered by Tablet PC stylus
...
#if (_WIN32_WINNT >= 0x0600)
#define TBNF_IMAGELABEL         0x00000004
#endif
...
#if (_WIN32_WINNT >= 0x0600)
    int iImageLabel;  // [out] image index for label
#endif
...
#define REBARCLASSNAME_MILW     L"ReBarWindow32_MIL"
#define REBARCLASSNAME_MILA     "ReBarWindow32_MIL"

#ifdef  UNICODE
#define REBARCLASSNAME          REBARCLASSNAMEW
#define REBARCLASSNAME_MIL      REBARCLASSNAME_MILW
#else
#define REBARCLASSNAME          REBARCLASSNAMEA
#define REBARCLASSNAME_MIL      REBARCLASSNAME_MILA
#endif

#else
#define REBARCLASSNAME          "ReBarWindow"
#define REBARCLASSNAME_MIL      "ReBarWindow_MIL"
#endif
...
#if (_WIN32_WINNT >= 0x0600)
#define RBS_EX_TRANSPARENT            0x00000001	
#define RBS_EX_SPLITTER               0x00000002 // Shows the splitter, default to bottom in horizontal mode and right in vertical mode.
#endif       // __WIN32_WINNT >= 0x0600
#endif      // _WIN32_IE >= 0x0400
...
#define TTTOOLINFOA_V6_SIZE CCSIZEOF_STRUCT(TTTOOLINFOA, hbmp)
#define TTTOOLINFOW_V6_SIZE CCSIZEOF_STRUCT(TTTOOLINFOW, hbmp)
...
#endif
#if (_WIN32_WINNT >= 0x0600)
    HBITMAP hbmp;   // the large preview bitmap we show in the tooltip
#endif
...
#if (_WIN32_WINNT >= 0x600)
#define TTF_BITMAP              0x00010000   // for downlevel compliancy
#endif
...
#define PROGRESS_CLASS_MILA     "msctls_progress32_MIL"
#define PROGRESS_CLASS_MILW     L"msctls_progress32_MIL"


#ifdef UNICODE
#define  PROGRESS_CLASS         PROGRESS_CLASSW
#define  PROGRESS_CLASS_MIL     PROGRESS_CLASS_MILW
#else
#define  PROGRESS_CLASS         PROGRESS_CLASSA
#define  PROGRESS_CLASS_MIL     PROGRESS_CLASS_MILA
#endif
...
#if (_WIN32_WINNT >= 0x0600)
#define PBM_ANIMATE             (WM_USER+11) // wParam = TRUE/FALSE
#define PBM_TRANSITIONTOPOS (WM_USER+12) // wParam = position, lParam = int (milliseconds)
#endif      // _WIN32_WINNT >= 0x0600
...
#define WC_LISTVIEW_MILA        "SysListView32_MIL"
#define WC_LISTVIEW_MILW        L"SysListView32_MIL"

#ifdef UNICODE
#define WC_LISTVIEW             WC_LISTVIEWW
#define WC_LISTVIEW_MIL         WC_LISTVIEW_MILW
#else
#define WC_LISTVIEW             WC_LISTVIEWA
#define WC_LISTVIEW_MIL         WC_LISTVIEW_MILA
#endif
...
#if (_WIN32_WINNT >= 0x0600)
#define LVIF_IMAGETITLE         0x00000020
#define LVIF_TASKS              0x00000400
...
#define LVTF_HOVERONLY   1
#define LVTF_TEXTONLY    2

typedef struct tagLVTASK
{
    LPCWSTR pszText;
    DWORD   dwId;
    DWORD   dwFlags;
...
#define LVHT_EX_GROUP_STATEICON    0x02000000
#define LVHT_EX_GROUP              (LVHT_EX_GROUP_BACKGROUND | LVHT_EX_GROUP_COLLAPSE | LVHT_EX_GROUP_FOOTER | LVHT_EX_GROUP_HEADER | LVHT_EX_GROUP_STATEICON)
#define LVHT_EX_ONCONTENTS         0x01000000 // On item AND not on the background
...
#define LVCFMT_LINKS_PARSEONLY      0x10000  // Parse out markup tags but don't show links
#define LVCFMT_LINKS_PARSEANDSHOW   0x20000  // Parse and show hyperlinks
#define LVCFMT_LINKS_SHOWAUTOMATIC  0x30000  // Whole item is a link with no anchor tag
#define LVCFMT_LINKS_MASK           (LVCFMT_LINKS_PARSEONLY | LVCFMT_LINKS_PARSEANDSHOW | LVCFMT_LINKS_SHOWAUTOMATIC)
#define LVCFMT_TILE_FIRST           0x100000 // First column always
#define LVCFMT_TILE_SECOND          0x200000 // Second column if there's three
#define LVCFMT_TILE_THIRD           0x400000 // Third formated column
#define LVCFMT_TILE_PLACEMENTMASK   (LVCFMT_TILE_FIRST | LVCFMT_TILE_SECOND | LVCFMT_TILE_THIRD)
#define LVCFMT_TILE_MULTILINE       0x800000 // Takes a whole column
#define LVCFMT_HIDDEN              0x1000000 // Column is hidden; same as HDF_HIDDEN
#endif
...
#define LVS_EX_SHOWNUMORDER     0x01000000
#define LVS_EX_AUTOAUTOARRANGE  0x02000000  // Icons automatically arrange if no icon positions have been set
#define LVS_EX_HEADERINALLMODES 0x04000000  // Show column headers in all view modes
#define LVS_EX_AUTOCHECKSELECT  0x10000000
#define LVS_EX_AUTOSIZECOLUMNS  0x40000000
...
#define LV_VIEW_CAROUSEL        0x0005
#define LV_VIEW_PANORAMA        0x0006
#define LV_VIEW_MAX             0x0006
...
typedef struct tagLVSETINFOTIP
{
    ...
    int iSubItem;
#if (_WIN32_WINNT >= 0x0600)
    HBITMAP hbmp;   // large preview in tooltip
#endif
} LVSETINFOTIP, *PLVSETINFOTIP;

// LVSETINFOTIP.dwFlag values

#if (_WIN32_WINNT >= 0x0600)
#define LVSIT_BITMAP    0x0001
#endif
...
#if (_WIN32_WINNT >= 0x0600)
#define LVN_ORDERCHANGED        (LVN_FIRST-84)
#define LVN_LINKCLICK           (LVN_FIRST-85)

#define LVADPART_ITEM           0   // iItem, iSubItem = listview item/subitem index, lParam = item lParam
#define LVADPART_GROUP          1   // iItem = group id, iSubItem = lParam = unused
#define LVADPART_IMAGETITLE     2   // iItem, iSubItem = listview item/subitem index, lParam = item lParam
...
#define ADRF_DRAWSYNC           0x00000000  // draw synchronously (act same as if LVS_EX_DRAWIMAGEASYNC weren't set)
#define ADRF_DRAWNOTHING        0x00000001  // draw nothing (LVADPART_ITEM, LVADPART_GROUP)
#define ADRF_DRAWFALLBACK       0x00000002  // draw fallback text (LVADPART_IMAGETITLE)
#define ADRF_DRAWIMAGE          0x00000004  // draw image returned in iRetImageIndex instead
...
#define ANIMATE_CLASS_MILW      L"SysAnimate32_MIL"
#define ANIMATE_CLASS_MILA      "SysAnimate32_MIL"


#ifdef UNICODE
#define ANIMATE_CLASS           ANIMATE_CLASSW
#define ANIMATE_CLASS_MIL       ANIMATE_CLASS_MILW
#else
#define ANIMATE_CLASS           ANIMATE_CLASSA
#define ANIMATE_CLASS_MIL       ANIMATE_CLASS_MILA
#endif
...
#if (_WIN32_WINNT >= 0x600)
#define ACM_OPENXFILEA          (WM_USER+104)
#define ACM_OPENXFILEW          (WM_USER+105)
#define ACM_SETTEXTUREW         (WM_USER+106)
#define ACM_SETTEXTUREA         (WM_USER+107)

#ifdef UNICODE
#define ACM_OPENXFILE           ACM_OPENXFILEW
#define ACM_SETTEXTURE          ACM_SETTEXTUREW
#else
#define ACM_OPENXFILE           ACM_OPENXFILEA
#define ACM_SETTEXTURE          ACM_SETTEXTUREA
#endif
...
#define WC_BUTTON_MILA          "Button_MIL"
#define WC_BUTTON_MILW          L"Button_MIL"

#ifdef UNICODE
#define WC_BUTTON               WC_BUTTONW
#define WC_BUTTON_MIL           WC_BUTTON_MILW
#else
#define WC_BUTTON               WC_BUTTONA
#define WC_BUTTON_MIL           WC_BUTTON_MILA
#endif
...
#define Button_SetDropDownState(hwnd, pState) \
...
#define WC_STATIC_MILA          "Static_MIL"
#define WC_STATIC_MILW          L"Static_MIL"

#ifdef UNICODE
#define WC_STATIC               WC_STATICW
#define WC_STATIC_MIL           WC_STATIC_MILW
#else
#define WC_STATIC               WC_STATICA
#define WC_STATIC_MIL           WC_STATIC_MILA
#endif
...
typedef int (CALLBACK *PFNDPAENUMCALLBACKCONST)(const void *p, void *pData);
typedef int (CALLBACK *PFNDSAENUMCALLBACK)(void *p, void *pData);
typedef int (CALLBACK *PFNDSAENUMCALLBACKCONST)(const void *p, void *pData);
...
#ifdef __cplusplus
extern "C++" __inline void DSA_DestroyCallback(HDSA hdsa, PFNDSAENUMCALLBACKCONST pfnCB, void *pData)
{
    DSA_DestroyCallback(hdsa, (PFNDSAENUMCALLBACK)pfnCB, pData);
}
#endif
...
#ifdef __cplusplus
extern "C++" __inline void DPA_EnumCallback(HDPA hdpa, PFNDPAENUMCALLBACKCONST pfnCB, void *pData)
{
    DPA_EnumCallback(hdpa, (PFNDPAENUMCALLBACK)pfnCB, pData);
}
#endif

WINCOMMCTRLAPI void   WINAPI DPA_DestroyCallback(HDPA hdpa, PFNDPAENUMCALLBACK pfnCB, void *pData);
#ifdef __cplusplus
extern "C++" __inline void DPA_DestroyCallback(HDPA hdpa, PFNDPAENUMCALLBACKCONST pfnCB, void *pData)
{
    DPA_DestroyCallback(hdpa, (PFNDPAENUMCALLBACK)pfnCB, pData);
}
#endif

WINCOMMCTRLAPI BOOL   WINAPI DPA_SetPtr(HDPA hdpa, int i, const void *p);
WINCOMMCTRLAPI int    WINAPI DPA_InsertPtr(HDPA hdpa, int i, const void *p);
...
typedef int (CALLBACK *PFNDPACOMPARECONST)(const void *p1, const void *p2, LPARAM lParam);

WINCOMMCTRLAPI BOOL   WINAPI DPA_Sort(HDPA hdpa, PFNDPACOMPARE pfnCompare, LPARAM lParam);
#ifdef __cplusplus
extern "C++" __inline BOOL DPA_Sort(HDPA hdpa, PFNDPACOMPARECONST pfnCompare, LPARAM lParam)
{
    return DPA_Sort(hdpa, (PFNDPACOMPARE)(pfnCompare), lParam);
}
#endif
...
#ifdef __cplusplus
extern "C++" __inline int DPA_Search(HDPA hdpa, const void *pFind, int iStart, PFNDPACOMPARECONST pfnCompare, LPARAM lParam, UINT options)
{
    return DPA_Search(hdpa, const_cast<void *>(pFind), iStart, (PFNDPACOMPARE)pfnCompare, lParam, options);
}
#endif
...
WINCOMMCTRLAPI void WINAPI DrawScrollArrow(HDC hdc, LPCRECT lprc, UINT wControlState, COLORREF rgbOveride);
#endif
...
#define WC_HISTOGRAM         L"Histogram"

#define HSTM_INSERTGROUP    (HSTM_FIRST)
#define HSTM_SETGROUP       (HSTM_FIRST + 1)
#define HSTM_GETGROUP       (HSTM_FIRST + 2)
#define HSTM_DELETEGROUP    (HSTM_FIRST + 3)

#define HSTM_SETITEM    (HSTM_FIRST + 4)
#define HSTM_GETITEM    (HSTM_FIRST + 5)
#define HSTM_DELETEITEM (HSTM_FIRST + 6)

#define HSTM_SETRANGESELECTION      (HSTM_FIRST + 7)
#define HSTM_SETRANGESELECTIONSTART (HSTM_FIRST + 8)
#define HSTM_GETRANGESELECTIONSTART (HSTM_FIRST + 9)
#define HSTM_SETRANGESELECTIONEND   (HSTM_FIRST + 10)
#define HSTM_GETRANGESELECTIONEND   (HSTM_FIRST + 11)
#define HSTM_CLEARRANGESELECTION    (HSTM_FIRST + 12)

#define HSTM_SETFOCUS (HSTM_FIRST + 13)
#define HSTM_GETFOCUS (HSTM_FIRST + 14)

typedef struct _HST_POS
{
    int iGroupID;   // Group Identifier (-1 if only using SetRange)
    int iPos;       // Position identifier [iRangeMin,iRangeMax] of group
} HST_POS, *LPHST_POS;

typedef struct _HST_ITEM
{
    UINT mask;      // REQUIRED: Mask of set or get fields
    HST_POS pos;    // REQUIRED: Position identifier
    
    DWORD fState;   // State Flags
    int iCount;     // Count of this bar (translates into height, default 0)
    LPARAM lParam;  // User Data
} HST_ITEM, *LPHST_ITEM;

#define HSTIF_STATE   0x00000001
#define HSTIF_COUNT   0x00000002
#define HSTIF_LPARAM  0x00000004

#define HSTIS_SELECT  0x00000001

typedef struct _HST_GROUP
{
    UINT mask;        // REQUIRED: Mask of fields
    int iGroupID;     // REQUIRED: ID of this group    
    
    WCHAR szText[60]; // text name of this group
    int iRangeMin;    // min and max of items associated with this group
    int iRangeMax;
    LPARAM lParam;    // User Data
} HST_GROUP, *LPHST_GROUP;

#define HSTGF_TEXT   0x00000001
#define HSTGF_RANGE  0x00000002
#define HSTGF_LPARAM 0x00000004

#define Histogram_InsertGroup(hwnd, pgroup) \
    (BOOL)SNDMSG((hwnd), HSTM_INSERTGROUP, 0, (LPARAM)(pgroup))
#define Histogram_SetGroup(hwnd, pgroup) \
    (BOOL)SNDMSG((hwnd), HSTM_SETGROUP, 0, (LPARAM)(pgroup))
#define Histogram_GetGroup(hwnd, pgroup) \
    (BOOL)SNDMSG((hwnd), HSTM_GETGROUP, 0, (LPARAM)(pgroup))
#define Histogram_DeleteGroup(hwnd, pgroup) \
    (BOOL)SNDMSG((hwnd), HSTM_DELETEGROUP, 0, (LPARAM)(pgroup))    

#define Histogram_SetItem(hwnd, pitem) \
    (BOOL)SNDMSG((hwnd), HSTM_SETITEM, 0, (LPARAM)(pitem))
#define Histogram_GetItem(hwnd, pitem) \
    (BOOL)SNDMSG((hwnd), HSTM_GETITEM, 0, (LPARAM)(pitem))
#define Histogram_DeleteItem(hwnd, pitem) \
    (BOOL)SNDMSG((hwnd), HSTM_DELETEITEM, 0, (LPARAM)(pitem))
    
#define Histogram_SetRangeSelection(hwnd, start, end) \
    (BOOL)SNDMSG((hwnd), HSTM_SETRANGESELECTION, (WPARAM)(start), (LPARAM)(end))
#define Histogram_SetRangeSelectionStart(hwnd, start) \
    (BOOL)SNDMSG((hwnd), HSTM_SETRANGESELECTIONSTART, 0, (LPARAM)(start))
#define Histogram_GetRangeSelectionStart(hwnd, start) \
    (BOOL)SNDMSG((hwnd), HSTM_GETRANGESELECTIONSTART, 0, (LPARAM)(start))
#define Histogram_SetRangeSelectionEnd(hwnd, end) \
    (BOOL)SNDMSG((hwnd), HSTM_SETRANGESELECTIONEND, 0, (LPARAM)(end))
#define Histogram_GetRangeSelectionEnd(hwnd, end) \
    (BOOL)SNDMSG((hwnd), HSTM_GETRANGESELECTIONEND, 0, (LPARAM)(end))
#define Histogram_ClearRangeSelection(hwnd) \
    (BOOL)SNDMSG((hwnd), HSTM_CLEARRANGESELECTION, 0, 0)

#define Histogram_SetFocus(hwnd, pos) \
    (BOOL)SNDMSG((hwnd), HSTM_SETFOCUS, 0, (LPARAM)(pos))
#define Histogram_GetFocus(hwnd, pos) \
    (BOOL)SNDMSG((hwnd), HSTM_GETFOCUS, 0, (LPARAM)(pos))   

#define HSTN_KEYDOWN           (HSTN_FIRST - 0)  // Called when a key is pressed, key can be cancelled

#define HSTN_GROUPINSERT       (HSTN_FIRST - 1)  // Called when a group is added
#define HSTN_GROUPCHANGING     (HSTN_FIRST - 2)  // Called after parameter validation, before change takes effect
#define HSTN_GROUPCHANGED      (HSTN_FIRST - 3)  // Called after change takes effect
#define HSTN_GROUPDELETE       (HSTN_FIRST - 4)  // Called when a group is deleted

#define HSTN_ITEMCHANGING      (HSTN_FIRST - 5)  // Called after parameter validation, before change takes effect
#define HSTN_ITEMCHANGED       (HSTN_FIRST - 6)  // Called after change takes effect
#define HSTN_ITEMDELETE        (HSTN_FIRST - 7)  // Called when an item is deleted
#define HSTN_ITEMFOCUS         (HSTN_FIRST - 8)  // Called when an item recieves focus

#define HSTN_GETINFOTIP        (HSTN_FIRST - 9)  // Called to request tooltip data

typedef struct tagHSTKEY
{
    NMHDR hdr;
    WORD wVKey;
    UINT flags;
...
typedef struct tagHSTGROUP
{
    NMHDR hdr;
    UINT mask;
    int iGroupID;
    LPARAM lParam;
} NMHSTGROUP, *LPNMHSTGROUP;

typedef struct tagHSTITEM
{
    NMHDR hdr;
    UINT mask;
    HST_POS pos;
