...
{
    // Animation Schemes...
    WIZARD05_HEADERBITMAP_ANIMATION_SCHEME_0 = 0,
    WIZARD05_HEADERBITMAP_ANIMATION_SCHEME_1,
    // Count
    WIZARD05_HEADERBITMAP_ANIMATION_SCHEME_COUNT
} 
WIZARD05_HEADERBITMAP_ANIMATION_SCHEME;
#endif
...
typedef struct _PROPSHEETPAGEA_V4
{
    ...
    WIZARD05_HEADERBITMAP_ANIMATION_SCHEME  wiz05HeaderBitmapAnimation;
...
{
    // Animation Schemes...
    WIZARD05_HEADERBACKGROUND_ANIMATION_SCHEME_0 = 0,
    WIZARD05_HEADERBACKGROUND_ANIMATION_SCHEME_1,
    // Count
    WIZARD05_HEADERBACKGROUND_ANIMATION_SCHEME_COUNT
} 
WIZARD05_HEADERBACKGROUND_ANIMATION_SCHEME;
#endif
...
#if (_WIN32_WINNT >= 0x600)
typedef struct _PROPSHEETHEADERA_V3
{
    PROPSHEETHEADERA_V1_FIELDS
    ...
    WIZARD05_HEADERBACKGROUND_ANIMATION_SCHEME     wiz05HeaderBackgroundScheme;
} PROPSHEETHEADERA_V3, *LPPROPSHEETHEADERA_V3;
typedef const PROPSHEETHEADERA_V3 *LPCPROPSHEETHEADERA_V3;
#endif 
...
#if (_WIN32_WINNT >= 0x600)
typedef struct _PROPSHEETHEADERW_V3
{
    PROPSHEETHEADERW_V1_FIELDS
    ...
    WIZARD05_HEADERBACKGROUND_ANIMATION_SCHEME     wiz05HeaderBackgroundScheme;
} PROPSHEETHEADERW_V3, *LPPROPSHEETHEADERW_V3;
typedef const PROPSHEETHEADERW_V3 *LPCPROPSHEETHEADERW_V3;
#endif 
...
#if (_WIN32_WINNT >= 0x600)
#define PROPSHEETHEADERA_V3_SIZE sizeof(PROPSHEETHEADERA_V3)
#define PROPSHEETHEADERW_V3_SIZE sizeof(PROPSHEETHEADERW_V3)
#endif
...
#if (_WIN32_WINNT >= 0x600)
#define    _PROPSHEETHEADERA        PROPSHEETHEADERA_V3;
#define    _PROPSHEETHEADERW        PROPSHEETHEADERW_V3;
typedef    PROPSHEETHEADERA_V3      PROPSHEETHEADERA;
typedef    PROPSHEETHEADERW_V3      PROPSHEETHEADERW;
typedef  LPPROPSHEETHEADERA_V3      LPPROPSHEETHEADERA;
typedef  LPPROPSHEETHEADERW_V3      LPPROPSHEETHEADERW;
typedef LPCPROPSHEETHEADERA_V3      LPCPROPSHEETHEADERA;
typedef LPCPROPSHEETHEADERW_V3      LPCPROPSHEETHEADERW;
#elif (_WIN32_IE >= 0x400)
...
#endif
#if (_WIN32_WINNT >= 0x600)
#define PROPSHEETHEADER_V3_SIZE PROPSHEETHEADERW_V3_SIZE
#endif
#else
...
#endif
#if (_WIN32_WINNT >= 0x600)
#define PROPSHEETHEADER_V3_SIZE PROPSHEETHEADERA_V3_SIZE
#endif
#endif
...
#if (_WIN32_WINNT >= 0x0600)
// Only for PSH_WIZARD05 - used in PSM_SHOWWIZBUTTONS
#define PSWIZB_CANCEL           0x00000010
#define PSWIZB_HELP             0x00000020
#endif // 0x0605
...
#if (_WIN32_WINNT >= 0x0600)
// Only UNICODE
// These messages are only for Wizard05 style wizards. The Wizard author
// needs to specify the PSH_WIZARD05 flag in the dwFlags member of the PROPSHEETHEADER
...
#define PropSheet_ShowWizButtons(hDlg, dwFlag, dwButton) \
        SNDMSG(hDlg, PSM_SHOWWIZBUTTONS, (WPARAM)(dwFlag), (LPARAM)(dwButton))


#define PSM_SETHEADERBITMAPANIMATION      (WM_USER + 139)

#define PropSheet_SetHeaderBitmapAnimation(hDlg, iPageIndex, wiz05HeaderBitmapAnimation) \
        SNDMSG(hDlg, PSM_SETHEADERBITMAPANIMATION, (WPARAM) iPageIndex, (LPARAM)(wiz05HeaderBitmapAnimation))

#define PSM_SETHEADERBITMAP         (WM_USER + 140)

#define PropSheet_SetHeaderBitmap(hDlg, iPageIndex, hbmHeader) \
        SNDMSG(hDlg, PSM_SETHEADERBITMAP, (WPARAM) iPageIndex, (LPARAM)(hbmHeader))


#define PSM_SETHEADERBITMAPRESOURCEA    (WM_USER + 141)
#define PSM_SETHEADERBITMAPRESOURCEW    (WM_USER + 142)

#ifdef UNICODE
#define PSM_SETHEADERBITMAPRESOURCE      PSM_SETHEADERBITMAPRESOURCEW
#else
#define PSM_SETHEADERBITMAPRESOURCE      PSM_SETHEADERBITMAPRESOURCEA
#endif

#define PropSheet_SetHeaderBitmapResource(hDlg, iPageIndex, lpszbmHeader) \
        SNDMSG(hDlg, PSM_SETHEADERBITMAP, (WPARAM) iPageIndex, (LPARAM)(lpszbmHeader))
