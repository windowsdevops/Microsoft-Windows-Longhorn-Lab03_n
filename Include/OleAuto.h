...
HRESULT WINAPI IsolationAwareLoadTypeLib(const OLECHAR*szFile,ITypeLib**pptlib);
HRESULT WINAPI IsolationAwareLoadTypeLibEx(LPCOLESTR szFile,REGKIND regkind,ITypeLib**pptlib);
HRESULT WINAPI IsolationAwareLoadRegTypeLib(REFGUID rguid,WORD wVerMajor,WORD wVerMinor,LCID lcid,ITypeLib**pptlib);
HRESULT WINAPI IsolationAwareQueryPathOfRegTypeLib(REFGUID guid,USHORT wMaj,USHORT wMin,LCID lcid,LPBSTR lpbstrPathName);
HRESULT WINAPI IsolationAwareRegisterTypeLib(ITypeLib*ptlib,OLECHAR*szFullPath,OLECHAR*szHelpDir);
HRESULT WINAPI IsolationAwareUnRegisterTypeLib(REFGUID libID,WORD wVerMajor,WORD wVerMinor,LCID lcid,SYSKIND syskind);
HRESULT WINAPI IsolationAwareCreateTypeLib2(SYSKIND syskind,LPCOLESTR szFile,ICreateTypeLib2**ppctlib);
HRESULT WINAPI IsolationAwareCreateDispTypeInfo(INTERFACEDATA*pidata,LCID lcid,ITypeInfo**pptinfo);
HRESULT WINAPI IsolationAwareCreateStdDispatch(IUnknown*punkOuter,void*pvThis,ITypeInfo*ptinfo,IUnknown**ppunkStdDisp);
HRESULT WINAPI IsolationAwareRegisterActiveObject(IUnknown*punk,REFCLSID rclsid,DWORD dwFlags,DWORD*pdwRegister);
HRESULT WINAPI IsolationAwareRevokeActiveObject(DWORD dwRegister,void*pvReserved);
HRESULT WINAPI IsolationAwareGetActiveObject(REFCLSID rclsid,void*pvReserved,IUnknown**ppunk);
HRESULT WINAPI IsolationAwareCreateErrorInfo(ICreateErrorInfo**pperrinfo);
HRESULT WINAPI IsolationAwareGetRecordInfoFromGuids(REFGUID rGuidTypeLib,ULONG uVerMajor,ULONG uVerMinor,LCID lcid,REFGUID rGuidTypeInfo,IRecordInfo**ppRecInfo);

ISOLATION_AWARE_INLINE HRESULT OleautoIsolationAwarePrivateJVaQPGbueRfhYg(void)
{
...
#if !ISOLATION_AWARE_USE_STATIC_LIBRARY
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareLoadTypeLib(const OLECHAR*szFile,ITypeLib**pptlib)
{
    HRESULT result = S_OK;
    ...
    if (!fActivateActCtxSuccess)
        return OleautoIsolationAwarePrivateJVaQPGbueRfhYg();
    __try
    {
        result = LoadTypeLib(szFile,pptlib);
    }
    __finally
    {
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareLoadTypeLibEx(LPCOLESTR szFile,REGKIND regkind,ITypeLib**pptlib)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = LoadTypeLibEx(szFile,regkind,pptlib);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareLoadRegTypeLib(REFGUID rguid,WORD wVerMajor,WORD wVerMinor,LCID lcid,ITypeLib**pptlib)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = LoadRegTypeLib(rguid,wVerMajor,wVerMinor,lcid,pptlib);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareQueryPathOfRegTypeLib(REFGUID guid,USHORT wMaj,USHORT wMin,LCID lcid,LPBSTR lpbstrPathName)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = QueryPathOfRegTypeLib(guid,wMaj,wMin,lcid,lpbstrPathName);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareRegisterTypeLib(ITypeLib*ptlib,OLECHAR*szFullPath,OLECHAR*szHelpDir)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = RegisterTypeLib(ptlib,szFullPath,szHelpDir);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareUnRegisterTypeLib(REFGUID libID,WORD wVerMajor,WORD wVerMinor,LCID lcid,SYSKIND syskind)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = UnRegisterTypeLib(libID,wVerMajor,wVerMinor,lcid,syskind);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareCreateTypeLib2(SYSKIND syskind,LPCOLESTR szFile,ICreateTypeLib2**ppctlib)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = CreateTypeLib2(syskind,szFile,ppctlib);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareCreateDispTypeInfo(INTERFACEDATA*pidata,LCID lcid,ITypeInfo**pptinfo)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = CreateDispTypeInfo(pidata,lcid,pptinfo);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareCreateStdDispatch(IUnknown*punkOuter,void*pvThis,ITypeInfo*ptinfo,IUnknown**ppunkStdDisp)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = CreateStdDispatch(punkOuter,pvThis,ptinfo,ppunkStdDisp);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareRegisterActiveObject(IUnknown*punk,REFCLSID rclsid,DWORD dwFlags,DWORD*pdwRegister)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = RegisterActiveObject(punk,rclsid,dwFlags,pdwRegister);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareRevokeActiveObject(DWORD dwRegister,void*pvReserved)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = RevokeActiveObject(dwRegister,pvReserved);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareGetActiveObject(REFCLSID rclsid,void*pvReserved,IUnknown**ppunk)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = GetActiveObject(rclsid,pvReserved,ppunk);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareCreateErrorInfo(ICreateErrorInfo**pperrinfo)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareGetRecordInfoFromGuids(REFGUID rGuidTypeLib,ULONG uVerMajor,ULONG uVerMinor,LCID lcid,REFGUID rGuidTypeInfo,IRecordInfo**ppRecInfo)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = GetRecordInfoFromGuids(rGuidTypeLib,uVerMajor,uVerMinor,lcid,rGuidTypeInfo,ppRecInfo);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
#define CreateDispTypeInfo IsolationAwareCreateDispTypeInfo
#define CreateErrorInfo IsolationAwareCreateErrorInfo
#define CreateStdDispatch IsolationAwareCreateStdDispatch
#define CreateTypeLib2 IsolationAwareCreateTypeLib2
#define GetActiveObject IsolationAwareGetActiveObject
#define GetRecordInfoFromGuids IsolationAwareGetRecordInfoFromGuids
#define LoadRegTypeLib IsolationAwareLoadRegTypeLib
#define LoadTypeLib IsolationAwareLoadTypeLib
#define LoadTypeLibEx IsolationAwareLoadTypeLibEx
#define QueryPathOfRegTypeLib IsolationAwareQueryPathOfRegTypeLib
#define RegisterActiveObject IsolationAwareRegisterActiveObject
#define RegisterTypeLib IsolationAwareRegisterTypeLib
#define RevokeActiveObject IsolationAwareRevokeActiveObject
#define UnRegisterTypeLib IsolationAwareUnRegisterTypeLib
