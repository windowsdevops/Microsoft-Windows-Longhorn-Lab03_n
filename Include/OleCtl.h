...
HRESULT WINAPI IsolationAwareOleCreatePropertyFrame(HWND hwndOwner,UINT x,UINT y,LPCOLESTR lpszCaption,ULONG cObjects,LPUNKNOWN*ppUnk,ULONG cPages,LPCLSID pPageClsID,LCID lcid,DWORD dwReserved,LPVOID pvReserved);
HRESULT WINAPI IsolationAwareOleCreatePropertyFrameIndirect(LPOCPFIPARAMS lpParams);
HRESULT WINAPI IsolationAwareOleTranslateColor(OLE_COLOR clr,HPALETTE hpal,COLORREF*lpcolorref);
HRESULT WINAPI IsolationAwareOleCreateFontIndirect(LPFONTDESC lpFontDesc,REFIID riid,LPVOID*lplpvObj);
HRESULT WINAPI IsolationAwareOleCreatePictureIndirect(LPPICTDESC lpPictDesc,REFIID riid,BOOL fOwn,LPVOID*lplpvObj);
HRESULT WINAPI IsolationAwareOleLoadPicture(LPSTREAM lpstream,long lSize,BOOL fRunmode,REFIID riid,LPVOID*lplpvObj);
HRESULT WINAPI IsolationAwareOleLoadPictureEx(LPSTREAM lpstream,long lSize,BOOL fRunmode,REFIID riid,DWORD xSizeDesired,DWORD ySizeDesired,DWORD dwFlags,LPVOID*lplpvObj);
HRESULT WINAPI IsolationAwareOleLoadPicturePath(LPOLESTR szURLorPath,LPUNKNOWN punkCaller,DWORD dwReserved,OLE_COLOR clrReserved,REFIID riid,LPVOID*ppvRet);
HRESULT WINAPI IsolationAwareOleLoadPictureFile(VARIANT varFileName,LPDISPATCH*lplpdispPicture);
HRESULT WINAPI IsolationAwareOleLoadPictureFileEx(VARIANT varFileName,DWORD xSizeDesired,DWORD ySizeDesired,DWORD dwFlags,LPDISPATCH*lplpdispPicture);
HRESULT WINAPI IsolationAwareOleSavePictureFile(LPDISPATCH lpdispPicture,BSTR bstrFileName);
HCURSOR WINAPI IsolationAwareOleIconToCursor(HINSTANCE hinstExe,HICON hIcon);

ISOLATION_AWARE_INLINE HRESULT OlectlIsolationAwarePrivateJVaQPGbueRfhYg(void)
{
...
#if !ISOLATION_AWARE_USE_STATIC_LIBRARY
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareOleCreatePropertyFrame(HWND hwndOwner,UINT x,UINT y,LPCOLESTR lpszCaption,ULONG cObjects,LPUNKNOWN*ppUnk,ULONG cPages,LPCLSID pPageClsID,LCID lcid,DWORD dwReserved,LPVOID pvReserved)
{
    HRESULT result = S_OK;
    ...
    if (!fActivateActCtxSuccess)
        return OlectlIsolationAwarePrivateJVaQPGbueRfhYg();
    __try
    {
        result = OleCreatePropertyFrame(hwndOwner,x,y,lpszCaption,cObjects,ppUnk,cPages,pPageClsID,lcid,dwReserved,pvReserved);
    }
    __finally
    {
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareOleCreatePropertyFrameIndirect(LPOCPFIPARAMS lpParams)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = OleCreatePropertyFrameIndirect(lpParams);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareOleTranslateColor(OLE_COLOR clr,HPALETTE hpal,COLORREF*lpcolorref)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = OleTranslateColor(clr,hpal,lpcolorref);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareOleCreateFontIndirect(LPFONTDESC lpFontDesc,REFIID riid,LPVOID*lplpvObj)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = OleCreateFontIndirect(lpFontDesc,riid,lplpvObj);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareOleCreatePictureIndirect(LPPICTDESC lpPictDesc,REFIID riid,BOOL fOwn,LPVOID*lplpvObj)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = OleCreatePictureIndirect(lpPictDesc,riid,fOwn,lplpvObj);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareOleLoadPicture(LPSTREAM lpstream,long lSize,BOOL fRunmode,REFIID riid,LPVOID*lplpvObj)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = OleLoadPicture(lpstream,lSize,fRunmode,riid,lplpvObj);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareOleLoadPictureEx(LPSTREAM lpstream,long lSize,BOOL fRunmode,REFIID riid,DWORD xSizeDesired,DWORD ySizeDesired,DWORD dwFlags,LPVOID*lplpvObj)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = OleLoadPictureEx(lpstream,lSize,fRunmode,riid,xSizeDesired,ySizeDesired,dwFlags,lplpvObj);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareOleLoadPicturePath(LPOLESTR szURLorPath,LPUNKNOWN punkCaller,DWORD dwReserved,OLE_COLOR clrReserved,REFIID riid,LPVOID*ppvRet)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = OleLoadPicturePath(szURLorPath,punkCaller,dwReserved,clrReserved,riid,ppvRet);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareOleLoadPictureFile(VARIANT varFileName,LPDISPATCH*lplpdispPicture)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = OleLoadPictureFile(varFileName,lplpdispPicture);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareOleLoadPictureFileEx(VARIANT varFileName,DWORD xSizeDesired,DWORD ySizeDesired,DWORD dwFlags,LPDISPATCH*lplpdispPicture)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = OleLoadPictureFileEx(varFileName,xSizeDesired,ySizeDesired,dwFlags,lplpdispPicture);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HRESULT WINAPI IsolationAwareOleSavePictureFile(LPDISPATCH lpdispPicture,BSTR bstrFileName)
{
    HRESULT result = S_OK;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    ...
    __try
    {
        result = OleSavePictureFile(lpdispPicture,bstrFileName);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
...
ISOLATION_AWARE_INLINE HCURSOR WINAPI IsolationAwareOleIconToCursor(HINSTANCE hinstExe,HICON hIcon)
{
    HCURSOR cursorResult = (SetLastError(NO_ERROR),NULL);
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess = IsolationAwarePrivateT_SqbjaYRiRY || IsolationAwarePrivatenPgViNgRzlnPgpgk(&ulpCookie);
    if (!fActivateActCtxSuccess)
        return cursorResult;
    __try
    {
        cursorResult = OleIconToCursor(hinstExe,hIcon);
    }
    __finally
    {
        if (!IsolationAwarePrivateT_SqbjaYRiRY)
        {
            const BOOL fPreserveLastError = (cursorResult == NULL);
...
#define OleCreateFontIndirect IsolationAwareOleCreateFontIndirect
#define OleCreatePictureIndirect IsolationAwareOleCreatePictureIndirect
#define OleCreatePropertyFrame IsolationAwareOleCreatePropertyFrame
#define OleCreatePropertyFrameIndirect IsolationAwareOleCreatePropertyFrameIndirect
#define OleIconToCursor IsolationAwareOleIconToCursor
#define OleLoadPicture IsolationAwareOleLoadPicture
#define OleLoadPictureEx IsolationAwareOleLoadPictureEx
#define OleLoadPictureFile IsolationAwareOleLoadPictureFile
#define OleLoadPictureFileEx IsolationAwareOleLoadPictureFileEx
#define OleLoadPicturePath IsolationAwareOleLoadPicturePath
#define OleSavePictureFile IsolationAwareOleSavePictureFile
#define OleTranslateColor IsolationAwareOleTranslateColor
