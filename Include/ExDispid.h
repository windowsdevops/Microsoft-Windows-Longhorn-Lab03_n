...
#define DISPID_NEWWINDOWBLOCKED         276
#define DISPID_BROWSERACTIVATE      277   // Fired when a shell browser window is activated
#define DISPID_BROWSERDEACTIVATE    278   // Fired when a shell browser window is deactivated
#define DISPID_BROWSERMAXIMIZE      279   // Fired when a shell browser window is maximized
#define DISPID_BROWSERRESTORE       280   // Fired when a shell browser window is restored
#define DISPID_P3PPOLICYREF         281   // Fired to indicate if a P3P policyref does or doesn't exist.
