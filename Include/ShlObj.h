...
//
// Notes:
//  In next version of Windows release, SHGetMalloc will be replaced by
// the following macro.
//
...
DECLARE_INTERFACE_IID_(IContextMenu, IUnknown, "000214e4-0000-0000-c000-000000000046")
{
    // *** IUnknown methods ***
...
DECLARE_INTERFACE_IID_(IContextMenu2, IContextMenu, "000214f4-0000-0000-c000-000000000046")
{
    // *** IUnknown methods ***
    STDMETHOD(QueryInterface) (THIS_ REFIID riid, void **ppv) PURE;
    STDMETHOD_(ULONG,AddRef) (THIS)  PURE;
...
DECLARE_INTERFACE_IID_(IContextMenu3, IContextMenu2, "BCFCE0A0-EC17-11d0-8D10-00A0C90F2719")
{
    // *** IUnknown methods ***
    STDMETHOD(QueryInterface) (THIS_ REFIID riid, void **ppv) PURE;
    STDMETHOD_(ULONG,AddRef) (THIS)  PURE;
...
typedef enum {
   ...
   SLDF_FORCE_NO_LINKTRACK      = 0x00040000,   // don't create link tracking data for the target
   SLDF_ENABLE_TARGET_METADATA  = 0x00080000,   // enable caching of target metadata into link
   SLDF_HAS_PROPBAG             = 0x00100000,
...
#define EXP_RESOLVERS_SIG           0xA000000A      // Custom Link Handler's data


#undef  INTERFACE
#define INTERFACE IShellLinkDataList

DECLARE_INTERFACE_IID_(IShellLinkDataList, IUnknown, "45e2b4ae-b1c3-11d0-b92f-00a0c90312e1")
{
    // *** IUnknown methods ***
    STDMETHOD(QueryInterface) (THIS_ REFIID riid, void **ppv) PURE;
    STDMETHOD_(ULONG, AddRef) (THIS)  PURE;
...
#define CSIDL_PROFILES                  0x003e        // Documents and Setting directory

#define CSIDL_PLAYLISTS                 0x003f        // <user name>\My Music\Playlists
#define CSIDL_SAMPLE_MUSIC              0x0040        // All Users\My Documents\My Music\Sample Music
#define CSIDL_SAMPLE_PLAYLISTS          0x0041        // All Users\My Documents\My Music\Sample Playlists
#define CSIDL_SAMPLE_PICTURES           0x0042        // All Users\My Documents\My Pictures\Sample Pictures
#define CSIDL_SAMPLE_VIDEOS             0x0043        // All Users\My Documents\My Videos\Sample Videos

#define CSIDL_HARDWARE                  0x0044        // My Computer\Control Panel\My Hardware

#define CSIDL_PHOTOALBUMS               0x0045        // <user name>\My Pictures\Photo Albums

#define CSIDL_SYNCMANAGER               0x0046        // My Computer\Control Panel\Sync Manager
#define CSIDL_GAMELIBRARY               0x0047        // Game Library
#define CSIDL_COMMON_GAMELIBRARY        0x0048        // Common Game Library

#define CSIDL_COMMON_PROFILE            0x0049        // All Users profile

#define CSIDL_NOTES                     0x004a        // "My Notes" folder
...
DECLARE_INTERFACE_IID_(IFileSystemBindData, IUnknown, "01E18D10-4D8B-11d2-855D-006008059367")
{
    // *** IUnknown methods ***
    STDMETHOD(QueryInterface) (THIS_ REFIID riid, void **ppv) PURE;
    STDMETHOD_(ULONG,AddRef) (THIS)  PURE;
...
#define PROGDLG_NOCANCEL        0x00000020      // No cancel button (operation cannot be canceled) (use sparingly)
...
#define CFSTR_STICKYNOTEPATH                TEXT("StickyNotePath")                      // (Sticky note file path)
...
#define QIF_SHOWIMAGE           0x00000004
...
SHSTDAPI_(HANDLE) SHChangeNotification_Lock(HANDLE hChangeNotification, DWORD dwProcessId, PIDLIST_ABSOLUTE **pppidl, LONG *plEvent);
...
#define SHDID_COMPUTER_LIBRARIES    22
#define SHDID_SHAREPOINT_SITES      23
...
SHSTDAPI_(PUIDLIST_RELATIVE) ILFindChild(PCIDLIST_ABSOLUTE pidlParent, PCIDLIST_ABSOLUTE pidlChild);
...
#endif
SHSTDAPI SHILCreateFromPath(LPCWSTR szPath, PIDLIST_ABSOLUTE *ppidl, DWORD *rgfInOut);
//===========================================================================
...
//  Do NOT use me                     0x40000036,
    ...
    REST_NOEXPLORERESTART           = 0x4000006C,   // disables the timer loop to cause Explorer to restart.
    REST_NOSENDTOMENU               = 0x4000006D,   // removes the sendto menu.
    REST_NOSMWELCOME                = 0x4000006E,   // Don't pop up the start menu on login or after n hours of idle time
    ...
    REST_NOSMMYHARDWARE             = 0x40000085,   // don't show "My Hardware" on the start menu
    ...
    REST_LOSSYIMAGEROTATE           = 0x40000088,   // Don't rotate images if it could lose data
    REST_NOREMOTERECURSIVEEVENTS    = 0x40000089,   // Dont register network change events recursively to avoid network traffic
    REST_DISPLAYNAME_REMOVABLEDISK  = 0x4000008A,   // DisplayName tweaking for Removable media drives: Zip, CF, SmartMedia, MemStick, Floppies
    REST_DISPLAYNAME_OPTICALDISK    = 0x4000008B,   // DisplayName tweaking for Optical media drives: CD, DVD, CD-R/RW, ...
    REST_DISPLAYNAME_FIXEDDISK      = 0x4000008C,   // DisplayName tweaking for Fixed disk drives: internal or external
    REST_DISPLAYNAME_REMOTEDRIVE    = 0x4000008D,   // DisplayName tweaking for Remote drives: mapped net shares
    REST_DISPLAYNAME_FLOPPY         = 0x4000008E,   // DisplayName tweaking for Floppies
    REST_NOSMMYGAMES                = 0x4000008F,   // Don't show "My Games" on the start menu    
    REST_NODRIVESINSENDTOMENU       = 0x40000090,   // don't enumerate my computer in sendto menu
    ...
    REST_NOSMMYCONTACTS             = 0x40000096,   // don't show "My Contacts" on the start menu
    REST_DISABLESIDEBAR             = 0x40000097,   // Disable the Sidebar and avalon taskbar
    REST_SHOWNETWORKPROVIDERS       = 0x40000098,   // show the network providers when browsing Entire Network
    REST_NOFAVORITESBAND            = 0x40000099,   // Disables the favorites band in the navbar.  Causes Favorites menu to display in itbar.
...
SHSTDAPI CDefFolderMenu_Create2(PCIDLIST_ABSOLUTE pidlFolder, HWND hwnd,
...
typedef struct {
    ...
    // new for Longhorn
    BOOL fHideInkTitles: 1; 
    BOOL fAutoCheckSelect: 1;
    BOOL fUseRichInfotips: 1;
    BOOL fAutoSizeColumns: 1;
...
#define SSF_HIDEINKTITLES           0x00800000
#define SSF_AUTOCHECKSELECT         0x01000000
#define SSF_USERICHINFOTIPS         0x02000000
#define SSF_AUTOSIZECOLUMNS         0x04000000
...
//
SHSTDAPI SHPropStgCreate( IPropertySetStorage* psstg, REFFMTID fmtid, const CLSID *pclsid, DWORD grfFlags, DWORD grfMode, DWORD dwDisposition, OUT IPropertyStorage** ppstg, OUT OPTIONAL UINT* puCodePage );
...
SHSTDAPI SHCLSIDFromString(LPCWSTR lpsz, LPCLSID lpclsid);
...
SHSTDAPI_(int) PickIconDlg(HWND hwnd, LPWSTR pszIconPath, UINT cbIconPath, int *piIconIndex);
...
// HRESULT SHGetDropTargetForItem(HWND hwnd, IShellFolder *psf, PCUITEMID_CHILD pidl, IDataObject *pdtobj, IDropTarget **ppdrop);
//
// A helper function for getting a drop handler for the specified child item. 
//
// hwnd         View window in which drop is occuring
// psf          Shell folder containing the drop target
// pidl         Item that is the current drop target
// pdtobj       Data object containing data to be dropped
// ppdrop       Pointer to returned IDropTarget interface pointer
//
// Returns S_OK if a drop target interface is returned. Other failure codes means the function failed.

SHSTDAPI SHGetDropTargetForItem(HWND hwnd, IShellFolder *psf, PCUITEMID_CHILD pidl, IDataObject *pdtobj, IDropTarget **ppdrop);
