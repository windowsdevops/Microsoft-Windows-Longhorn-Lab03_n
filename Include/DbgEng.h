...
DECLARE_INTERFACE_(IDebugAdvanced2, IUnknown)
{
    ...
    STDMETHOD(Request)(
        THIS_
        __in ULONG Request,
        __in_bcount(InBufferSize) __opt PVOID InBuffer,
        __in ULONG InBufferSize,
        __out_bcount(OutBufferSize) __opt PVOID OutBuffer,
        __in ULONG OutBufferSize,
        __out __opt PULONG OutSize
        ) PURE;
    ...
    STDMETHOD(GetSourceFileInformation)(
        ...
        __in ULONG64 Arg64,
        __in ULONG Arg32,
        __out_bcount(BufferSize) __opt PVOID Buffer,
        __in ULONG BufferSize,
        __out __opt PULONG InfoSize
        ) PURE;
    STDMETHOD(FindSourceFileAndToken)(
        ...
        __in PCSTR File,
        __in ULONG Flags,
        __in_bcount(FileTokenSize) __opt PVOID FileToken,
        __in ULONG FileTokenSize,
        __out __opt PULONG FoundElement,
        __out_ecount(BufferSize) __opt PSTR Buffer,
        __in ULONG BufferSize,
        __out __opt PULONG FoundSize
        ) PURE;
    ...
    STDMETHOD(GetSymbolInformation)(
        ...
        __in ULONG BufferSize,
        __out __opt PULONG InfoSize,
        __out_ecount(StringBufferSize) __opt PSTR StringBuffer,
        __in ULONG StringBufferSize,
        __out __opt PULONG StringSize
        ) PURE;
...
DECLARE_INTERFACE_(IDebugAdvanced3, IUnknown)
{
    ...
    STDMETHOD(FindSourceFileAndTokenWide)(
        ...
        __in ULONG FileTokenSize,
        __out __opt PULONG FoundElement,
        __out_ecount(BufferSize) __opt PWSTR Buffer,
        __in ULONG BufferSize,
        __out __opt PULONG FoundSize
        ) PURE;
    ...
    STDMETHOD(GetSymbolInformationWide)(
        ...
        __in ULONG BufferSize,
        __out __opt PULONG InfoSize,
        __out_ecount(StringBufferSize) __opt PWSTR StringBuffer,
        __in ULONG StringBufferSize,
        __out __opt PULONG StringSize
        ) PURE;
};
...
#define DEBUG_ENGOPT_ALL                         0x0000FFFF
...
#define DEBUG_KERNEL_TRACE_LOG   2048
...
#define CreateProcessT CreateProcessWide
#define CreateProcessAndAttachT CreateProcessAndAttachWide
#define OpenDumpFileT OpenDumpFileWide
...
#define GetBreakpointByIndexT GetBreakpointByIndex2
#define GetBreakpointByIdT GetBreakpointById2
#define AddBreakpointT AddBreakpoint2
#define RemoveBreakpointT RemoveBreakpoint2
...
#define GetScopeSymbolGroupT GetScopeSymbolGroup2
#define CreateSymbolGroupT CreateSymbolGroup2
...
#define CreateProcessT CreateProcess
#define CreateProcessAndAttachT CreateProcessAndAttach
#define OpenDumpFileT OpenDumpFile
...
#define GetBreakpointByIndexT GetBreakpointByIndex
#define GetBreakpointByIdT GetBreakpointById
#define AddBreakpointT AddBreakpoint
#define RemoveBreakpointT RemoveBreakpoint
...
#define GetScopeSymbolGroupT GetScopeSymbolGroup
#define CreateSymbolGroupT CreateSymbolGroup
