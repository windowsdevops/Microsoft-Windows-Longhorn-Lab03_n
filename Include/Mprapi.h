...
MprAdminMIBEntryCreate(
    ...
    __in_bcount(dwEntrySize)  LPVOID                  lpEntry,
...
MprAdminMIBEntryGet(
    ...
    IN      DWORD                   dwProtocolId,
    IN      DWORD                   dwRoutingPid,
    __in_bcount(dwInEntrySize)  LPVOID                  lpInEntry,
...
MprAdminMIBGetTrapInfo(
    ...
    IN      DWORD                   dwProtocolId,
    IN      DWORD                   dwRoutingPid,
    __in_bcount(dwInDataSize)      LPVOID                  lpInData,
...
MprConfigTransportCreate(
    ...
    __in_bcount(dwClientInterfaceInfoSize) __opt   LPBYTE          pClientInterfaceInfo,
...
MprConfigTransportSetInfo(
    IN      HANDLE                  hMprConfig,
    IN      HANDLE                  hRouterTransport,
    __in_bcount(dwGlobalInfoSize) __opt      LPBYTE        pGlobalInfo,
    __in    DWORD                   dwGlobalInfoSize,
    __in_bcount(dwClientInterfaceInfoSize) __opt  LPBYTE   pClientInterfaceInfo,
    __in    DWORD                   dwClientInterfaceInfoSize,
...
MprConfigInterfaceTransportAdd(
    ...
    IN      DWORD                   dwTransportId,
    IN      LPWSTR                  lpwsTransportName           OPTIONAL,
    __in_bcount(dwInterfaceInfoSize)   LPBYTE          pInterfaceInfo,
...
MprConfigInterfaceTransportGetInfo(
    ...
    __out __opt LPDWORD                 lpdwInterfaceInfoSize
);
...
MprConfigInterfaceTransportSetInfo(
    ...
    IN      HANDLE                  hRouterInterface,
    IN      HANDLE                  hRouterIfTransport,
    __in_bcount(dwInterfaceInfoSize) __opt  LPBYTE                  pInterfaceInfo,
    __in    DWORD                   dwInterfaceInfoSize
);
...
MprConfigInterfaceTransportEnum(
    ...
    __inout __opt LPDWORD                 lpdwResumeHandle
);
