...
#define SERVICE_ACCEPT_ALL                     (SERVICE_ACCEPT_STOP |                   \
...
#define SERVICE_CONFIG_PRESHUTDOWN_INFO         3

//
// Info level for NotifyServiceStatusChange
//
#define SERVICE_NOTIFY_STATUS_CHANGE            1
...
#define SERVICE_NOTIFY_ALL                      ( SERVICE_NOTIFY_STOPPED | \
