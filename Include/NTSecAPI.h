...
typedef enum _POLICY_INFORMATION_CLASS {
    ...
    PolicySharedAccountDomainInformation,
    PolicyLastInformation = PolicySharedAccountDomainInformation
...
typedef struct _LSA_UNICODE_STRING_LIST {
    ULONG NumberOfStrings;
#ifdef MIDL
    [size_is(NumberOfStrings)]
#endif
    PLSA_UNICODE_STRING Strings;
} LSA_UNICODE_STRING_LIST, *PLSA_UNICODE_STRING_LIST;

typedef struct _POLICY_SHARED_ACCOUNT_DOMAIN_INFO {
    LSA_UNICODE_STRING Name;     // shared account domain name
#ifdef MIDL_PASS
    PISID Sid;                   // shared account domain SID
#else
    PSID Sid;
#endif
    GUID Guid;                   // shared account domain GUID
    LSA_UNICODE_STRING_LIST Aliases; // shared account domain alias names
    LSA_UNICODE_STRING Description;  // shared account domain description
    LARGE_INTEGER CreationTime;  // shared account domain creation time
} POLICY_SHARED_ACCOUNT_DOMAIN_INFO, *PPOLICY_SHARED_ACCOUNT_DOMAIN_INFO;
...
typedef enum _POLICY_NOTIFICATION_INFORMATION_CLASS {
    ...
    PolicyNotifySharedAccountDomainInformation,
    PolicyNotifyLast = PolicyNotifySharedAccountDomainInformation
