...
typedef enum _NORM_FORM {
    ...
    NormalizationIDNA   = 0xD      // Mapped according to the IDNA spec
} NORM_FORM;
#endif /* WINVER >= 0x0600 */
...
MultiByteToWideChar(
    ...
    __out __opt LPWSTR  lpWideCharStr,
...
WideCharToMultiByte(
    ...
    __in int      cchWideChar,
    __out __opt LPSTR   lpMultiByteStr,
    __in int      cbMultiByte,
...
LCMapStringA(
    ...
    __in int      cchSrc,
    __out_ecount(cchDest) __opt LPSTR  lpDestStr,
    __in int      cchDest);
WINBASEAPI
int
WINAPI
LCMapStringW(
    ...
    __in int      cchSrc,
    __out_ecount(cchDest) __opt LPWSTR  lpDestStr,
    __in int      cchDest);
#ifdef UNICODE
...
GetLocaleInfoA(
    __in LCID     Locale,
    __in LCTYPE   LCType,
    __out_ecount(cchData) __opt LPSTR  lpLCData,
    __in int      cchData);
WINBASEAPI
int
WINAPI
GetLocaleInfoW(
    __in LCID     Locale,
    __in LCTYPE   LCType,
    __out_ecount(cchData) __opt LPWSTR  lpLCData,
    __in int      cchData);
#ifdef UNICODE
...
GetCalendarInfoA(
    ...
    __out_ecount(cchData) __opt LPSTR   lpCalData,
    __in int      cchData,
    __out __opt LPDWORD  lpValue);
WINBASEAPI
int
WINAPI
GetCalendarInfoW(
    ...
    __in CALID    Calendar,
    __in CALTYPE  CalType,
    __out_ecount(cchData) __opt LPWSTR   lpCalData,
    __in int      cchData,
    __out __opt LPDWORD  lpValue);
#ifdef UNICODE
...
LocaleNameFromLCIDW(
    ...
    __in int      cchName);
#ifdef UNICODE
#define LocaleNameFromLCID  LocaleNameFromLCIDW
#else
#define LocaleNameFromLCID  LocaleNameFromLCIDA
#endif // !UNICODE
...
LCIDFromLocaleNameW(
    __in LPWSTR lpName);
#ifdef UNICODE
#define LCIDFromLocaleName  LCIDFromLocaleNameW
#else
#define LCIDFromLocaleName  LCIDFromLocaleNameA
#endif // !UNICODE
#endif
...
GetTimeFormatA(
    __in LCID             Locale,
    __in DWORD            dwFlags,
    __in __opt CONST SYSTEMTIME *lpTime,
    __in __opt LPCSTR          lpFormat,
    __out_ecount(cchTime) __opt LPSTR          lpTimeStr,
    __in int              cchTime);
WINBASEAPI
int
WINAPI
GetTimeFormatW(
    ...
    __in DWORD            dwFlags,
    __in __opt CONST SYSTEMTIME *lpTime,
    __in __opt LPCWSTR          lpFormat,
    __out_ecount(cchTime) __opt LPWSTR          lpTimeStr,
    __in int              cchTime);
#ifdef UNICODE
...
GetDurationFormatA(
    __in LCID             Locale,
    __in DWORD            dwFlags,
    __in __opt CONST SYSTEMTIME *lpDuration,
    __in ULONGLONG ullDuration,
    __in __opt LPCSTR          lpFormat,
    __out_ecount(cchDuration) __opt LPSTR          lpDurationStr,
...
GetDurationFormatW(
    ...
    __in ULONGLONG ullDuration,
    __in __opt LPCWSTR          lpFormat,
    __out_ecount(cchDuration) __opt LPWSTR          lpDurationStr,
    __in int              cchDuration);
#ifdef UNICODE
#define GetDurationFormat  GetDurationFormatW
#else
#define GetDurationFormat  GetDurationFormatA
#endif // !UNICODE
#endif /* WINVER >= 0x0600 */
...
GetDateFormatA(
    __in LCID             Locale,
    __in DWORD            dwFlags,
    __in __opt CONST SYSTEMTIME *lpDate,
    __in __opt LPCSTR          lpFormat,
    __out_ecount(cchDate) __opt LPSTR          lpDateStr,
    __in int              cchDate);
WINBASEAPI
int
WINAPI
GetDateFormatW(
    ...
    __in __opt CONST SYSTEMTIME *lpDate,
    __in __opt LPCWSTR          lpFormat,
    __out_ecount(cchDate) __opt LPWSTR          lpDateStr,
    __in int              cchDate);
#ifdef UNICODE
...
GetNumberFormatA(
    ...
    __in DWORD            dwFlags,
    __in LPCSTR          lpValue,
    __in __opt CONST NUMBERFMTA *lpFormat,
    __out_ecount(cchNumber) __opt LPSTR          lpNumberStr,
    __in int              cchNumber);
WINBASEAPI
int
WINAPI
GetNumberFormatW(
    ...
    __in __opt CONST NUMBERFMTW *lpFormat,
    __out_ecount(cchNumber) __opt LPWSTR          lpNumberStr,
    __in int              cchNumber);
#ifdef UNICODE
...
GetCurrencyFormatA(
    ...
    __in DWORD              dwFlags,
    __in LPCSTR            lpValue,
    __in __opt CONST CURRENCYFMTA *lpFormat,
    __out_ecount(cchCurrency) __opt LPSTR            lpCurrencyStr,
...
GetCurrencyFormatW(
    ...
    __in DWORD              dwFlags,
    __in LPCWSTR            lpValue,
    __in __opt CONST CURRENCYFMTW *lpFormat,
    __out_ecount(cchCurrency) __opt LPWSTR            lpCurrencyStr,
    __in int                cchCurrency);
#ifdef UNICODE
...
GetNLSVersion(
    ...
    __in  LCID             Locale,
    __out LPNLSVERSIONINFO lpVersionInformation);
...
GetGeoInfoA(
    ...
    __in_ecount(cchData) LPSTR     lpGeoData,
    __in int         cchData,
    __in LANGID      LangId);
WINBASEAPI
int
...
GetGeoInfoW(
    __in GEOID       Location,
    __in GEOTYPE     GeoType,
    __in_ecount(cchData) LPWSTR     lpGeoData,
    __in int         cchData,
    __in LANGID      LangId);
#ifdef UNICODE
...
GetFileMUIPath(
                LPWSTR pszFilePath ,
                PWSTR pszFileMUIPath,
                PULONG pccFileMUIPath,
                LANGID  *pLangID,
                PWSTR pszISOLanguage,
                PULONG pccISOLanguage,
