...
#if (!defined(NTDDI_VERSION) || (NTDDI_VERSION >= NTDDI_WINXP)) // DDK versioning
...
#define CRED_TARGETNAME_LEGACY_GENERIC_NAMESPACE CRED_TARGETNAME_LEGACY_GENERIC_NAMESPACE_W
...
#define CRED_TARGETNAME_LEGACY_GENERIC_NAMESPACE CRED_TARGETNAME_LEGACY_GENERIC_NAMESPACE_A
...
#define CRED_FLAGS_VALID_FLAGS          0x001F  // Mask of all valid flags
...
#define CRED_TI_TSSSO_TARGET            0x0040  // TargetName is for a TSSSO (TS single sign-on) credential
#define CRED_TI_VALID_FLAGS             0x007F
...
#endif // (!defined(NTDDI_VERSION) || (NTDDI_VERSION >= NTDDI_WINXP))
