...
#define MILCORE_TS_QUERYVER          4124   /* private escape */
#define MILCORE_TS_WMRECORD          4125   /* private escape */
#define MILCORE_TS_PROCESSPACKET     4126   /* private escape */
...
WINGDIAPI BOOL  WINAPI BitBlt( __in HDC hdc, __in int x, __in int y, __in int cx, __in int cy, __in __opt HDC hdcSrc, __in int x1, __in int y1, __in DWORD rop);
...
WINGDIAPI int     WINAPI CombineRgn( __in __opt HRGN hrgnDst, __in __opt HRGN hrgnSrc1, __in __opt HRGN hrgnSrc2, __in int iMode);
WINGDIAPI HMETAFILE WINAPI CopyMetaFileA( __in HMETAFILE, __in __opt LPCSTR);
WINGDIAPI HMETAFILE WINAPI CopyMetaFileW( __in HMETAFILE, __in __opt LPCWSTR);
#ifdef UNICODE
#define CopyMetaFile  CopyMetaFileW
#else
#define CopyMetaFile  CopyMetaFileA
#endif // !UNICODE
WINGDIAPI HBITMAP WINAPI CreateBitmap( __in int nWidth, __in int nHeight, __in UINT nPlanes, __in UINT nBitCount, __in __opt CONST VOID *lpBits);
WINGDIAPI HBITMAP WINAPI CreateBitmapIndirect( __in __opt CONST BITMAP *pbm);
...
WINGDIAPI HDC     WINAPI CreateCompatibleDC( __in __opt HDC hdc);
WINGDIAPI HDC     WINAPI CreateDCA( __in __opt LPCSTR pwszDriver, __in __opt LPCSTR pwszDevice, __in __opt LPCSTR pszPort, __in __opt CONST DEVMODEA * pdm);
WINGDIAPI HDC     WINAPI CreateDCW( __in __opt LPCWSTR pwszDriver, __in __opt LPCWSTR pwszDevice, __in __opt LPCWSTR pszPort, __in __opt CONST DEVMODEW * pdm);
#ifdef UNICODE
#define CreateDC  CreateDCW
#else
#define CreateDC  CreateDCA
#endif // !UNICODE
WINGDIAPI HBITMAP WINAPI CreateDIBitmap( __in HDC hdc, __in __opt CONST BITMAPINFOHEADER *pbmih, __in DWORD flInit, __in __opt CONST VOID *pjBits, __in __opt CONST BITMAPINFO *pbmi, __in UINT iUsage);
WINGDIAPI HBRUSH  WINAPI CreateDIBPatternBrush( __in HGLOBAL h, __in UINT iUsage);
WINGDIAPI HBRUSH  WINAPI CreateDIBPatternBrushPt( __in __typefix(CONST LPBITMAPINFO) CONST VOID *lpPackedDIB, __in UINT iUsage);
...
WINGDIAPI HFONT   WINAPI CreateFontA( __in int cHeight, __in int cWidth, __in int cEscapement, __in int cOrientation, __in int cWeight, __in DWORD bItalic,
                             ...
                             __in DWORD iQuality, __in DWORD iPitchAndFamily, __in __opt LPCSTR pszFaceName);
WINGDIAPI HFONT   WINAPI CreateFontW( __in int cHeight, __in int cWidth, __in int cEscapement, __in int cOrientation, __in int cWeight, __in DWORD bItalic,
                             __in DWORD bUnderline, __in DWORD bStrikeOut, __in DWORD iCharSet, __in DWORD iOutPrecision, __in DWORD iClipPrecision,
                             __in DWORD iQuality, __in DWORD iPitchAndFamily, __in __opt LPCWSTR pszFaceName);
#ifdef UNICODE
...
WINGDIAPI HDC     WINAPI CreateICA( __in __opt LPCSTR pszDriver, __in __opt LPCSTR pszDevice, __in __opt LPCSTR pszPort, __in __opt CONST DEVMODEA * pdm);
WINGDIAPI HDC     WINAPI CreateICW( __in __opt LPCWSTR pszDriver, __in __opt LPCWSTR pszDevice, __in __opt LPCWSTR pszPort, __in __opt CONST DEVMODEW * pdm);
#ifdef UNICODE
#define CreateIC  CreateICW
#else
#define CreateIC  CreateICA
#endif // !UNICODE
WINGDIAPI HDC     WINAPI CreateMetaFileA( __in __opt LPCSTR pszFile);
WINGDIAPI HDC     WINAPI CreateMetaFileW( __in __opt LPCWSTR pszFile);
#ifdef UNICODE
...
WINGDIAPI HRGN    WINAPI CreatePolyPolygonRgn( __in CONST POINT *lppt, __in_ecount(nCount) CONST INT *pc, __in int nCount, __in int Mode);
...
WINGDIAPI BOOL    WINAPI CreateScalableFontResourceA( __in DWORD fdwHidden, __in LPCSTR lpszFont, __in LPCSTR lpszFile, __in __opt LPCSTR lpszPath);
WINGDIAPI BOOL    WINAPI CreateScalableFontResourceW( __in DWORD fdwHidden, __in LPCWSTR lpszFont, __in LPCWSTR lpszFile, __in __opt LPCWSTR lpszPath);
#ifdef UNICODE
...
WINGDIAPI BOOL WINAPI DeleteDC( __in __opt HDC hdc);
WINGDIAPI BOOL WINAPI DeleteMetaFile( __in __opt HMETAFILE hmf);
WINGDIAPI BOOL WINAPI DeleteObject( __in __opt HGDIOBJ ho);
WINGDIAPI int  WINAPI DescribePixelFormat( __in HDC hdc, __in int iFmt, __in UINT cb, __out_bcount(cb) __opt LPPIXELFORMATDESCRIPTOR ppfd);
...
WINSPOOLAPI int  WINAPI DeviceCapabilitiesA( __in LPCSTR pDevice, __in __opt LPCSTR pPort, __in WORD fwCapability,
                                __out __opt LPSTR pOutput, __in __opt CONST DEVMODEA * pDevMode);
WINSPOOLAPI int  WINAPI DeviceCapabilitiesW( __in LPCWSTR pDevice, __in __opt LPCWSTR pPort, __in WORD fwCapability,
                                __out __opt LPWSTR pOutput, __in __opt CONST DEVMODEW * pDevMode);
#ifdef UNICODE
...
WINGDIAPI int  WINAPI DrawEscape( __in HDC hdc, __in int nEscape, __in int cbInput, __in_bcount(cbInput) __opt LPCSTR lpData);
WINGDIAPI BOOL WINAPI Ellipse( __in HDC hdc, __in int left, __in int top,  __in int right, __in int bottom);

#if(WINVER >= 0x0400)
WINGDIAPI int  WINAPI EnumFontFamiliesExA( __in HDC hdc, __in LPLOGFONTA lpLogfont, __in FONTENUMPROCA lpProc, __in __opt LPARAM lParam, __in DWORD dwFlags);
WINGDIAPI int  WINAPI EnumFontFamiliesExW( __in HDC hdc, __in LPLOGFONTW lpLogfont, __in FONTENUMPROCW lpProc, __in __opt LPARAM lParam, __in DWORD dwFlags);
#ifdef UNICODE
...
WINGDIAPI int  WINAPI EnumFontFamiliesA( __in HDC hdc, __in __opt LPCSTR lpLogfont, __in FONTENUMPROCA lpProc, __in __opt LPARAM lParam);
WINGDIAPI int  WINAPI EnumFontFamiliesW( __in HDC hdc, __in __opt LPCWSTR lpLogfont, __in FONTENUMPROCW lpProc, __in __opt LPARAM lParam);
#ifdef UNICODE
#define EnumFontFamilies  EnumFontFamiliesW
#else
#define EnumFontFamilies  EnumFontFamiliesA
#endif // !UNICODE
WINGDIAPI int  WINAPI EnumFontsA( __in HDC hdc, __in __opt LPCSTR lpLogfont,  __in FONTENUMPROCA lpProc, __in __opt LPARAM lParam);
WINGDIAPI int  WINAPI EnumFontsW( __in HDC hdc, __in __opt LPCWSTR lpLogfont,  __in FONTENUMPROCW lpProc, __in __opt LPARAM lParam);
#ifdef UNICODE
...
#ifdef STRICT
WINGDIAPI int  WINAPI EnumObjects( __in HDC hdc, __in int nType, __in GOBJENUMPROC lpFunc, __in __opt LPARAM lParam);
#else
WINGDIAPI int  WINAPI EnumObjects( __in HDC hdc, __in int nType, __in GOBJENUMPROC lpFunc, __in __opt LPVOID lParam);
#endif


WINGDIAPI BOOL WINAPI EqualRgn( __in HRGN hrgn1, __in HRGN hrgn2);
WINGDIAPI int  WINAPI Escape( __in HDC hdc, __in int nEscape, __in int cbInput, __in_bcount(cbInput) __opt LPCSTR lpDataIn,  __out __opt LPVOID lpOut);
WINGDIAPI int  WINAPI ExtEscape( __in HDC hdc, __in int nEscape, __in int cbInput, __in_bcount(cbInput) __opt LPCSTR lpDataIn, __in int cbOut, __out_bcount(cbOut) __opt LPSTR lpOut);
WINGDIAPI int  WINAPI ExcludeClipRect( __in HDC hdc, __in int left, __in int top, __in int right, __in int bottom);
WINGDIAPI HRGN WINAPI ExtCreateRegion( __reserved CONST XFORM * lpx, __in DWORD nCount, __in_bcount(nCount) CONST RGNDATA * lpData);
...
WINGDIAPI int   WINAPI GetBkMode( __in HDC hdc);
WINGDIAPI LONG  WINAPI GetBitmapBits( __in HBITMAP hbit, __in LONG cb, __out_bcount(cb) __opt LPVOID lpvBits);
...
#endif // !UNICODE
WINGDIAPI BOOL  APIENTRY GetCharABCWidthsA( __in HDC hdc, __in UINT iFirst, __in UINT iLast, __out_ecount(iLast + 1 - iFirst) LPABC lpABC);
WINGDIAPI BOOL  APIENTRY GetCharABCWidthsW( __in HDC hdc, __in UINT iFirst, __in UINT iLast, __out_ecount(iLast + 1 - iFirst) LPABC lpABC);
#ifdef UNICODE
...
WINGDIAPI int   WINAPI GetClipRgn( __in HDC hdc, __in __opt HRGN hrgn);
WINGDIAPI int   WINAPI GetMetaRgn( __in HDC hdc, __in __opt HRGN hrgn);
...
WINGDIAPI int   WINAPI GetDeviceCaps( __in __opt HDC hdc, __in int index);
WINGDIAPI int   WINAPI GetDIBits( __in HDC hdc, __in HBITMAP hbm, __in UINT start, __in UINT cLines,  __out __opt LPVOID lpvBits, __inout LPBITMAPINFO lpbmi, __in UINT usage);
WINGDIAPI DWORD WINAPI GetFontData( __in HDC hdc, __in DWORD table, __in DWORD offset, __out_bcount(cbOut) __opt LPVOID, __in DWORD cbOut);
WINGDIAPI DWORD WINAPI GetGlyphOutlineA( __in HDC hdc, __in UINT uChar, __in UINT uFormat, __out LPGLYPHMETRICS lpgm, __in DWORD cb, __out_bcount(cb) __opt LPVOID lpvBuffer, __in CONST MAT2 * lpMat2);
WINGDIAPI DWORD WINAPI GetGlyphOutlineW( __in HDC hdc, __in UINT uChar, __in UINT uFormat, __out LPGLYPHMETRICS lpgm, __in DWORD cb, __out_bcount(cb) __opt LPVOID lpvBuffer, __in CONST MAT2 * lpMat2);
#ifdef UNICODE
...
WINGDIAPI UINT  WINAPI GetMetaFileBitsEx( __in HMETAFILE hmf, __in UINT cb,  __out_bcount(cb) __opt LPVOID lpvData);
...
WINGDIAPI UINT APIENTRY GetOutlineTextMetricsA( __in HDC hdc, __in UINT cb, __out_bcount(cb) __opt LPOUTLINETEXTMETRICA lpOTM);
WINGDIAPI UINT APIENTRY GetOutlineTextMetricsW( __in HDC hdc, __in UINT cb, __out_bcount(cb) __opt LPOUTLINETEXTMETRICW lpOTM);
#ifdef UNICODE
...
WINGDIAPI UINT  WINAPI GetPaletteEntries( __in HPALETTE h, __in UINT start, __in UINT count, __out_ecount(count) __opt LPPALETTEENTRY lppe);
...
WINGDIAPI BOOL  WINAPI GetRasterizerCaps( __out_bcount(c) LPRASTERIZER_STATUS lprs, __in UINT c);
WINGDIAPI int   WINAPI GetRandomRgn (__in HDC hdc, __in HRGN hrgn, __in INT i);
WINGDIAPI DWORD WINAPI GetRegionData(__in HRGN hrgn, __in DWORD c,  __out_bcount(c) __opt LPRGNDATA lpData);
...
WINGDIAPI UINT  WINAPI GetSystemPaletteEntries(__in HDC hdc, __in UINT iStart, __in UINT n, __out_ecount(n) __opt LPPALETTEENTRY lppe);
...
WINGDIAPI BOOL  APIENTRY GetTextExtentPointA(
                    __in HDC hdc,
                    __in_ecount(c) __opt LPCSTR lpString,
                    __in int c,
                    __out LPSIZE lpsz
                    );
WINGDIAPI BOOL  APIENTRY GetTextExtentPointW(
                    __in HDC hdc,
                    __in_ecount(c) __opt LPCWSTR lpString,
                    __in int c,
                    __out LPSIZE lpsz
                    );
#ifdef UNICODE
...
WINGDIAPI BOOL  APIENTRY GetTextExtentExPointA(
                    ...
                    __in int max,
                    __out __opt LPINT,
                    __out_ecount(c) __opt LPINT alpDx,
                    __out LPSIZE lpsz
                    );
...
WINGDIAPI int WINAPI GetTextCharsetInfo( __in HDC hdc, __out __opt LPFONTSIGNATURE lpSig, __in DWORD dwFlags);
...
WINGDIAPI DWORD WINAPI GetFontUnicodeRanges( __in HDC hdc, __out __opt LPGLYPHSET lpgs);
...
#endif // !UNICODE
WINGDIAPI BOOL  WINAPI GetTextExtentPointI( __in HDC hdc, __in_ecount(c) LPWORD pgi, __in int c, __out LPSIZE lpsz);
WINGDIAPI BOOL  WINAPI GetTextExtentExPointI( __in HDC hdc, __in_ecount(c) LPWORD pgi, __in int c, __in int nMax, __out LPINT lpnfit, __out_ecount(c) __opt LPINT alpDx, __out LPSIZE lpsz);
WINGDIAPI BOOL  WINAPI GetCharWidthI( __in HDC hdc, __in UINT giFirst, __in UINT c, __in_ecount(c) __opt LPWORD pgi, __out_ecount(c) LPINT lpBuffer);
WINGDIAPI BOOL  WINAPI GetCharABCWidthsI( __in HDC hdc, __in UINT giFirst, __in UINT c, __in_ecount(c) __opt LPWORD pgi, __out_ecount(c) LPABC lpabc);
...
#endif // !UNICODE
WINGDIAPI HANDLE WINAPI AddFontMemResourceEx( __in_bcount(cb) PVOID pb, __in DWORD cb, __reserved PVOID pdv, __in DWORD* pcFonts);
...
WINGDIAPI BOOL WINAPI LineDDA( __in int xStart, __in int yStart, __in int xEnd, __in int yEnd, __in LINEDDAPROC lpProc, __in __opt LPARAM data);
...
WINGDIAPI BOOL WINAPI PlgBlt( __in HDC hdcDest, __in CONST POINT * lpPoint, __in HDC hdcSrc, __in int xSrc, __in int ySrc, __in int width,
                     __in int height, __in __opt HBITMAP hbmMask, __in int xMask, __in int yMask);
...
WINGDIAPI BOOL WINAPI PolyPolygon(__in HDC hdc, __in CONST POINT * lpPoints, __in_ecount(c) CONST INT * lpCnt, __in int c);
...
WINGDIAPI int  WINAPI SelectClipRgn(__in HDC hdc, __in __opt HRGN hrgn);
WINGDIAPI int  WINAPI ExtSelectClipRgn(__in HDC hdc, __in __opt HRGN hrgn, __in int mode);
WINGDIAPI int  WINAPI SetMetaRgn(__in HDC hdc);
WINGDIAPI HGDIOBJ WINAPI SelectObject(__in HDC hdc, __in __opt HGDIOBJ h);
WINGDIAPI HPALETTE WINAPI SelectPalette(__in HDC hdc, __in __opt HPALETTE hPal, __in BOOL bForceBkgd);
...
WINGDIAPI LONG  WINAPI SetBitmapBits(__in HBITMAP hbm, __in DWORD c, __in_bcount(c) CONST VOID * lpData);

WINGDIAPI UINT  WINAPI SetBoundsRect(__in HDC hdc, __in __opt CONST RECT * lprect, __in UINT flags);
WINGDIAPI int   WINAPI SetDIBits(__in __opt HDC hdc, __in HBITMAP hbm, __in UINT start, __in UINT cLines, __in CONST VOID *lpBits, __in CONST BITMAPINFO * lpbmi, __in UINT ColorUse);
...
WINGDIAPI HMETAFILE   WINAPI SetMetaFileBitsEx(__in UINT cb, __in_bcount(cb) CONST BYTE * lpData);
WINGDIAPI UINT  WINAPI SetPaletteEntries(__in HPALETTE hpal, __in UINT start, __in UINT c, __in_ecount(c) CONST PALETTEENTRY * lppe);
...
WINGDIAPI BOOL   WINAPI StretchBlt(__in HDC hdcDest, __in int xDest, __in int yDest, __in int wDest, __in int hDest, __in __opt HDC hdcSrc, __in int xSrc, __in int ySrc, __in int wSrc, __in int hSrc, __in DWORD rop);
...
WINGDIAPI BOOL  WINAPI GradientFill( __in HDC hdc, __in_ecount(NumVertex) __opt PTRIVERTEX pVertex, __in ULONG NumVertex, __in PVOID pMesh, __in ULONG NumMesh, __in ULONG mode);
...
WINGDIAPI BOOL  WINAPI PlayMetaFileRecord( __in HDC hdc, __in_ecount(nHandles) LPHANDLETABLE lpht, __in LPMETARECORD lpmr, __in UINT nHandles);
typedef int (CALLBACK* MFENUMPROC)( __in HDC hdc, __in_ecount(nObj) HANDLETABLE FAR* lpht, __in METARECORD FAR* lpMR, __in int nObj, __in __opt LPARAM param);
WINGDIAPI BOOL  WINAPI EnumMetaFile( __in __opt HDC hdc, __in HMETAFILE hmf, __in MFENUMPROC proc, __in __opt LPARAM param);

typedef int (CALLBACK* ENHMFENUMPROC)(__in HDC hdc, __in_ecount(nHandles) HANDLETABLE FAR* lpht, __in CONST ENHMETARECORD * lpmr, __in int hHandles, __in __opt LPARAM data);

// Enhanced Metafile Function Declarations

WINGDIAPI HENHMETAFILE WINAPI CloseEnhMetaFile( __in HDC hdc);
WINGDIAPI HENHMETAFILE WINAPI CopyEnhMetaFileA( __in HENHMETAFILE hEnh, __in __opt LPCSTR lpFileName);
WINGDIAPI HENHMETAFILE WINAPI CopyEnhMetaFileW( __in HENHMETAFILE hEnh, __in __opt LPCWSTR lpFileName);
#ifdef UNICODE
#define CopyEnhMetaFile  CopyEnhMetaFileW
#else
#define CopyEnhMetaFile  CopyEnhMetaFileA
#endif // !UNICODE
WINGDIAPI HDC   WINAPI CreateEnhMetaFileA( __in __opt HDC hdc, __in __opt LPCSTR lpFilename, __in __opt CONST RECT *lprc, __in __opt LPCSTR lpDesc);
WINGDIAPI HDC   WINAPI CreateEnhMetaFileW( __in __opt HDC hdc, __in __opt LPCWSTR lpFilename, __in __opt CONST RECT *lprc, __in __opt LPCWSTR lpDesc);
#ifdef UNICODE
...
WINGDIAPI BOOL  WINAPI EnumEnhMetaFile( __in __opt HDC hdc, __in HENHMETAFILE hmf, __in ENHMFENUMPROC proc,
                                        __in LPVOID param, __in __opt CONST RECT * lpRect);
...
#endif // !UNICODE
WINGDIAPI UINT  WINAPI GetEnhMetaFileBits( __in HENHMETAFILE hmf, __in UINT cb, __out_bcount(cb) __opt LPBYTE lpbits);
WINGDIAPI UINT  WINAPI GetEnhMetaFileDescriptionA( __in HENHMETAFILE hmf, __in UINT cch,  __out_ecount(cch) __opt LPSTR lpszDesc);
WINGDIAPI UINT  WINAPI GetEnhMetaFileDescriptionW( __in HENHMETAFILE hmf, __in UINT cch,  __out_ecount(cch) __opt LPWSTR lpszDesc);
#ifdef UNICODE
#define GetEnhMetaFileDescription  GetEnhMetaFileDescriptionW
#else
#define GetEnhMetaFileDescription  GetEnhMetaFileDescriptionA
#endif // !UNICODE
WINGDIAPI UINT  WINAPI GetEnhMetaFileHeader( __in HENHMETAFILE hmf, __in UINT cb, __out_bcount(cb) __opt LPENHMETAHEADER lpemh);
WINGDIAPI UINT  WINAPI GetEnhMetaFilePaletteEntries( __in HENHMETAFILE hmf, __in UINT c, __out_ecount(c) __opt LPPALETTEENTRY lppe);
WINGDIAPI UINT  WINAPI GetEnhMetaFilePixelFormat( __in HENHMETAFILE hmf, __in UINT cb,
                                                  __out_bcount(cb) __opt PIXELFORMATDESCRIPTOR *);
WINGDIAPI UINT  WINAPI GetWinMetaFileBits( __in HENHMETAFILE hmf, __in UINT cb, __out_bcount(cb) __opt LPBYTE lpBuffer, __in INT mode, __in HDC hdcRef);
WINGDIAPI BOOL  WINAPI PlayEnhMetaFile( __in HDC hdc, __in HENHMETAFILE hmf, __in CONST RECT * lprect);
WINGDIAPI BOOL  WINAPI PlayEnhMetaFileRecord( __in HDC hdc, __in_ecount(nHandles) LPHANDLETABLE lpht, __in CONST ENHMETARECORD * lpemfr, __in UINT nHandles);
WINGDIAPI HENHMETAFILE  WINAPI SetEnhMetaFileBits( __in UINT cb, __in_bcount(cb) CONST BYTE * lpData);
WINGDIAPI HENHMETAFILE  WINAPI SetWinMetaFileBits( __in UINT cb, __in_bcount(cb) CONST BYTE * lpData, __in __opt HDC hdcRef, __in __opt CONST METAFILEPICT * lpmfp);
WINGDIAPI BOOL  WINAPI GdiComment( __in HDC hdc, __in UINT cb, __in_bcount(cb) CONST BYTE * lpData);
...
WINGDIAPI BOOL WINAPI PolyPolyline( __in HDC hdc,  __in CONST POINT * lppt, __in_ecount(c) CONST DWORD * lpdwPolyPoints, __in DWORD c);
WINGDIAPI BOOL WINAPI GetWorldTransform( __in HDC hdc, __out LPXFORM lpxf);
WINGDIAPI BOOL WINAPI SetWorldTransform( __in HDC hdc, __in __opt CONST XFORM * lpxf);
WINGDIAPI BOOL WINAPI ModifyWorldTransform( __in HDC hdc, __in __opt CONST XFORM * lpxf, __in DWORD mode);
WINGDIAPI BOOL WINAPI CombineTransform( __out LPXFORM lpxfOut, __in CONST XFORM *lpxf1, __in CONST XFORM *lpxf2);
WINGDIAPI HBITMAP WINAPI CreateDIBSection(__in __opt HDC hdc, __in CONST BITMAPINFO *lpbmi, __in UINT usage, __out __opt VOID **ppvBits, __in __opt HANDLE hSection, __in DWORD offset);
WINGDIAPI UINT WINAPI GetDIBColorTable( __in HDC hdc, __in UINT start, __in UINT c, __out_ecount(c) RGBQUAD * pColors);
WINGDIAPI UINT WINAPI SetDIBColorTable( __in HDC hdc, __in UINT start, __in UINT c, __in_ecount(c) CONST RGBQUAD *pColors);
...
WINGDIAPI HPALETTE WINAPI CreateHalftonePalette( __in __opt HDC hdc);
...
WINGDIAPI int  WINAPI GetPath(__in HDC hdc, __out_ecount(c) __opt LPPOINT lpPoints, __out_ecount(c) __opt LPBYTE, __in int c);
WINGDIAPI HRGN WINAPI PathToRegion(__in HDC hdc);
WINGDIAPI BOOL WINAPI PolyDraw(__in HDC hdc, __in_ecount(c) CONST POINT *lpPts, __in_ecount(c) CONST BYTE *lpbTypes, __in int c);
...
WINGDIAPI BOOL WINAPI SetMiterLimit(__in HDC hdc, __in FLOAT limit, __out __opt PFLOAT old);
...
WINGDIAPI HPEN WINAPI ExtCreatePen(__in DWORD style, __in DWORD width, __in CONST LOGBRUSH * lplb, __in DWORD c, __in_ecount(c) __opt CONST DWORD * lpStyle);
WINGDIAPI BOOL WINAPI GetMiterLimit(__in HDC hdc, __out PFLOAT plimit);
WINGDIAPI int  WINAPI GetArcDirection(__in HDC hdc);

WINGDIAPI int   WINAPI GetObjectA( __in HGDIOBJ h, __in int cb, __out_bcount(cb) __opt LPVOID buffer);
WINGDIAPI int   WINAPI GetObjectW( __in HGDIOBJ h, __in int cb, __out_bcount(cb) __opt LPVOID buffer);
#ifdef UNICODE
#define GetObject  GetObjectW
#else
#define GetObject  GetObjectA
#endif // !UNICODE
WINGDIAPI BOOL  WINAPI MoveToEx( __in HDC hdc, __in int x, __in int y, __out __opt LPPOINT lppt);
...
#endif // !UNICODE
WINGDIAPI BOOL  WINAPI ExtTextOutA( __in HDC hdc, __in int x, __in int y, __in UINT options, __in __opt CONST RECT * lprect, __in_ecount(c) __opt LPCSTR lpString, __in UINT c, __in_ecount(c) __opt CONST INT * lpDx);
WINGDIAPI BOOL  WINAPI ExtTextOutW( __in HDC hdc, __in int x, __in int y, __in UINT options, __in __opt CONST RECT * lprect, __in_ecount(c) __opt LPCWSTR lpString, __in UINT c, __in_ecount(c) __opt CONST INT * lpDx);
#ifdef UNICODE
#define ExtTextOut  ExtTextOutW
#else
#define ExtTextOut  ExtTextOutA
#endif // !UNICODE
WINGDIAPI BOOL  WINAPI PolyTextOutA( __in HDC hdc, __in_ecount(c) CONST POLYTEXTA * pptxt, __in int c);
WINGDIAPI BOOL  WINAPI PolyTextOutW( __in HDC hdc, __in_ecount(c) CONST POLYTEXTW * pptxt, __in int c);
#ifdef UNICODE
...
WINGDIAPI HRGN  WINAPI CreatePolygonRgn( __in_ecount(c) CONST POINT * lppt, __in int c, __in int mode);
...
WINGDIAPI BOOL  WINAPI Polygon( __in HDC hdc, __in_ecount(c) CONST POINT * lppt, __in int c);
WINGDIAPI BOOL  WINAPI Polyline( __in HDC hdc, __in_ecount(c) CONST POINT *, __in int c);

WINGDIAPI BOOL  WINAPI PolyBezier( __in HDC hdc, __in_ecount(c) CONST POINT * lppt, __in DWORD c);
WINGDIAPI BOOL  WINAPI PolyBezierTo( __in HDC hdc, __in_ecount(c) CONST POINT * lppt, __in DWORD c);
WINGDIAPI BOOL  WINAPI PolylineTo( __in HDC hdc, __in_ecount(c) CONST POINT * lppt, __in DWORD c);

WINGDIAPI BOOL  WINAPI SetViewportExtEx( __in HDC hdc, __in int x, __in int y, __out __opt LPSIZE lpsz);
WINGDIAPI BOOL  WINAPI SetViewportOrgEx( __in HDC hdc, __in int x, __in int y, __out __opt LPPOINT lppt);
WINGDIAPI BOOL  WINAPI SetWindowExtEx( __in HDC hdc, __in int x, __in int y, __out __opt LPSIZE lpsz);
WINGDIAPI BOOL  WINAPI SetWindowOrgEx( __in HDC hdc, __in int x, __in int y, __out __opt LPPOINT lppt);

WINGDIAPI BOOL  WINAPI OffsetViewportOrgEx( __in HDC hdc, __in int x, __in int y, __out __opt LPPOINT lppt);
WINGDIAPI BOOL  WINAPI OffsetWindowOrgEx( __in HDC hdc, __in int x, __in int y, __out __opt LPPOINT lppt);
WINGDIAPI BOOL  WINAPI ScaleViewportExtEx( __in HDC hdc, __in int xn, __in int dx, __in int yn, __in int yd, __out __opt LPSIZE lpsz);
WINGDIAPI BOOL  WINAPI ScaleWindowExtEx( __in HDC hdc, __in int xn, __in int xd, __in int yn, __in int yd, __out __opt LPSIZE lpsz);
WINGDIAPI BOOL  WINAPI SetBitmapDimensionEx( __in HBITMAP hbm, __in int w, __in int h, __out __opt LPSIZE lpsz);
WINGDIAPI BOOL  WINAPI SetBrushOrgEx( __in HDC hdc, __in int x, __in int y, __out __opt LPPOINT lppt);

WINGDIAPI int   WINAPI GetTextFaceA( __in HDC hdc, __in int c, __out_ecount(c) __opt LPSTR lpName);
WINGDIAPI int   WINAPI GetTextFaceW( __in HDC hdc, __in int c, __out_ecount(c) __opt LPWSTR lpName);
#ifdef UNICODE
...
WINGDIAPI DWORD WINAPI GetKerningPairsA( __in HDC hdc, __in DWORD c, __out_ecount(c) __opt LPKERNINGPAIR lpkp);
WINGDIAPI DWORD WINAPI GetKerningPairsW( __in HDC hdc, __in DWORD c, __out_ecount(c) __opt LPKERNINGPAIR lpkp);
#ifdef UNICODE
...
WINGDIAPI BOOL  WINAPI FixBrushOrgEx( __in HDC hdc, __in int x, __in int y,  __in LPPOINT ptl);
...
WINGDIAPI BOOL        WINAPI CheckColorsInGamut( __in HDC hdc, __in_ecount(c) __typefix(LPRGBTRIPLE) LPVOID lprgb, __out_bcount(c) LPVOID lpBuffer, __in DWORD c);
WINGDIAPI HCOLORSPACE WINAPI GetColorSpace( __in HDC hdc);
WINGDIAPI BOOL        WINAPI GetLogColorSpaceA( __in HCOLORSPACE hcs, __out_bcount(cb) LPLOGCOLORSPACEA lplcs, __in DWORD cb);
WINGDIAPI BOOL        WINAPI GetLogColorSpaceW( __in HCOLORSPACE hcs, __out_bcount(cb) LPLOGCOLORSPACEW lplcs, __in DWORD cb);
#ifdef UNICODE
...
WINGDIAPI BOOL        WINAPI GetICMProfileA( __in HDC hdc, __inout LPDWORD lpsize, __out_bcount(*lpsize) __opt LPSTR lpFileName);
WINGDIAPI BOOL        WINAPI GetICMProfileW( __in HDC hdc, __inout LPDWORD lpsize, __out_bcount(*lpsize) __opt LPWSTR lpFileName);
#ifdef UNICODE
...
WINGDIAPI int         WINAPI EnumICMProfilesA( __in HDC hdc, __in ICMENUMPROCA proc, __in __opt LPARAM param);
WINGDIAPI int         WINAPI EnumICMProfilesW( __in HDC hdc, __in ICMENUMPROCW proc, __in __opt LPARAM param);
#ifdef UNICODE
#define EnumICMProfiles  EnumICMProfilesW
#else
#define EnumICMProfiles  EnumICMProfilesA
#endif // !UNICODE
WINGDIAPI BOOL        WINAPI UpdateICMRegKeyA( __in DWORD reserved, __in LPSTR lpszCMID, __in LPSTR lpszFileName, __in UINT command);
WINGDIAPI BOOL        WINAPI UpdateICMRegKeyW( __in DWORD reserved, __in LPWSTR lpszCMID, __in LPWSTR lpszFileName, __in UINT command);
#ifdef UNICODE
