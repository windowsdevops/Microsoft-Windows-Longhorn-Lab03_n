...
//
// Include wtypes.h for our use of PROPERTYKEY and VARTYPE.
//
#include <wtypes.h>
...
typedef struct _SP_FILE_COPY_PARAMS_A {
    ...
    OPTIONAL PCSTR    SourceRootPath;
    OPTIONAL PCSTR    SourcePath;
             PCSTR    SourceFilename;
    OPTIONAL PCSTR    SourceDescription;
    OPTIONAL PCSTR    SourceTagfile;
             PCSTR    TargetDirectory;
    OPTIONAL PCSTR    TargetFilename;
             DWORD    CopyStyle;
    OPTIONAL HINF     LayoutInf;
    OPTIONAL PCSTR    SecurityDescriptor;
} SP_FILE_COPY_PARAMS_A, *PSP_FILE_COPY_PARAMS_A;

typedef struct _SP_FILE_COPY_PARAMS_W {
             DWORD    cbSize;
             HSPFILEQ QueueHandle;
    OPTIONAL PCWSTR   SourceRootPath;
    OPTIONAL PCWSTR   SourcePath;
             PCWSTR   SourceFilename;
    OPTIONAL PCWSTR   SourceDescription;
    OPTIONAL PCWSTR   SourceTagfile;
             PCWSTR   TargetDirectory;
    OPTIONAL PCWSTR   TargetFilename;
             DWORD    CopyStyle;
    OPTIONAL HINF     LayoutInf;
    OPTIONAL PCWSTR   SecurityDescriptor;
...
SetupGetInfInformationA(
    ...
    __out_bcount(ReturnBufferSize) __opt PSP_INF_INFORMATION ReturnBuffer,
    __in           DWORD               ReturnBufferSize,
    __out __opt PDWORD              RequiredSize
    );
...
SetupQueryInfFileInformationA(
    ...
    IN           UINT                InfIndex,
    __out_ecount(ReturnBufferSize) __opt PSTR    ReturnBuffer,
    __in         DWORD               ReturnBufferSize,
    __out __opt  PDWORD              RequiredSize
    );
...
SetupQueryInfFileInformationW(
    IN           PSP_INF_INFORMATION InfInformation,
    IN           UINT                InfIndex,
    __out_ecount(ReturnBufferSize) __opt PWSTR   ReturnBuffer,
    __in         DWORD               ReturnBufferSize,
    __out __opt  PDWORD              RequiredSize
    );
...
SetupGetInfFileListA(
    IN OPTIONAL  PCSTR  DirectoryPath,
    IN           DWORD  InfStyle,
    __out_ecount(ReturnBufferSize) __opt PSTR   ReturnBuffer,
    __in         DWORD  ReturnBufferSize,
    __out __opt  PDWORD RequiredSize
...
SetupGetInfFileListW(
    IN OPTIONAL  PCWSTR DirectoryPath,
    IN           DWORD  InfStyle,
    __out_ecount(ReturnBufferSize) __opt PWSTR  ReturnBuffer,
    __in         DWORD  ReturnBufferSize,
    __out __opt  PDWORD RequiredSize
...
SetupOpenInfFileW(
    IN           PCWSTR FileName,
    __in __opt   PCWSTR InfClass,
    IN           DWORD  InfStyle,
    __out __opt  PUINT  ErrorLine
    );
...
WINAPI
SetupGetLineTextA(
    IN OPTIONAL  PINFCONTEXT Context,
    IN OPTIONAL  HINF        InfHandle,
    IN OPTIONAL  PCSTR       Section,
    IN OPTIONAL  PCSTR       Key,
    __out_ecount(ReturnBufferSize) __opt PSTR        ReturnBuffer,
    __in         DWORD       ReturnBufferSize,
    __out __opt  PDWORD      RequiredSize
...
SetupGetMultiSzFieldA(
    ...
    __out_ecount(ReturnBufferSize) __opt PSTR        ReturnBuffer,
    __in         DWORD       ReturnBufferSize,
    __out  __opt LPDWORD     RequiredSize
    );
...
SetupGetBinaryField(
    IN           PINFCONTEXT Context,
    IN           DWORD       FieldIndex,
    __out_bcount(ReturnBufferSize) __opt PBYTE       ReturnBuffer,
    __in         DWORD       ReturnBufferSize,
    __out __opt  LPDWORD     RequiredSize
    );
...
SetupGetFileCompressionInfoExA(
    IN           PCSTR   SourceFileName,
    __out_ecount(ActualSourceFileNameBufferLen) __opt PSTR    ActualSourceFileNameBuffer,
    __in         DWORD   ActualSourceFileNameBufferLen,
    __out __opt  PDWORD  RequiredBufferLen,
    OUT          PDWORD  SourceFileSize,
    OUT          PDWORD  TargetFileSize,
    OUT          PUINT   CompressionType
    );
...
SetupGetFileCompressionInfoExW(
    IN           PCWSTR  SourceFileName,
    __out_ecount(ActualSourceFileNameBufferLen) __opt PWSTR   ActualSourceFileNameBuffer,
    __in         DWORD   ActualSourceFileNameBufferLen,
    __out __opt  PDWORD  RequiredBufferLen,
    OUT          PDWORD  SourceFileSize,
    OUT          PDWORD  TargetFileSize,
...
SetupDecompressOrCopyFileA(
    ...
    IN OPTIONAL PUINT CompressionType
    );
...
SetupGetSourceFileLocationA(
    IN           HINF        InfHandle,
    IN OPTIONAL  PINFCONTEXT InfContext,
    IN OPTIONAL  PCSTR       FileName,
    OUT          PUINT       SourceId,
    __out_ecount(ReturnBufferSize) __opt PSTR        ReturnBuffer,
    __in         DWORD       ReturnBufferSize,
...
SetupGetSourceFileSizeA(
    ...
    IN OPTIONAL PCSTR       Section,
    OUT         PDWORD      FileSize,
    IN OPTIONAL UINT        RoundingFactor
    );
...
SetupPromptForDiskA(
    IN          HWND   hwndParent,
    IN OPTIONAL PCSTR  DialogTitle,
    IN OPTIONAL PCSTR  DiskName,
    IN OPTIONAL PCSTR  PathToSource,
    IN          PCSTR  FileSought,
    IN OPTIONAL PCSTR  TagFile,
    IN          DWORD  DiskPromptStyle,
    __out_ecount(PathBufferSize)     PSTR   PathBuffer,
    __in        DWORD  PathBufferSize,
    __out __opt PDWORD PathRequiredSize
    );
...
SetupPromptForDiskW(
    IN          HWND   hwndParent,
    IN OPTIONAL PCWSTR DialogTitle,
    IN OPTIONAL PCWSTR DiskName,
    IN OPTIONAL PCWSTR PathToSource,
    IN          PCWSTR FileSought,
    IN OPTIONAL PCWSTR TagFile,
    IN          DWORD  DiskPromptStyle,
    __out_ecount(PathBufferSize)   PWSTR  PathBuffer,
    __in        DWORD  PathBufferSize,
    __out __opt PDWORD PathRequiredSize
    );
...
SetupCopyErrorA(
    ...
    IN           PCSTR  SourceFile,
    IN OPTIONAL  PCSTR  TargetPathFile,
    IN           UINT   Win32ErrorCode,
    IN           DWORD  Style,
    __out_ecount(PathBufferSize) __opt PSTR   PathBuffer,
    __in         DWORD  PathBufferSize,
    __out __opt  PDWORD PathRequiredSize
    );
...
SetupCopyErrorW(
    ...
    IN OPTIONAL  PCWSTR TargetPathFile,
    IN           UINT   Win32ErrorCode,
    IN           DWORD  Style,
    __out_ecount(PathBufferSize) __opt PWSTR  PathBuffer,
    __in         DWORD  PathBufferSize,
    __out __opt  PDWORD PathRequiredSize
    );
...
SetupSetDirectoryIdA(
    IN          HINF  InfHandle,
    IN OPTIONAL DWORD Id,
    IN OPTIONAL PCSTR Directory
    );
...
SetupInstallFileA(
    IN OPTIONAL HINF                InfHandle,
    IN OPTIONAL PINFCONTEXT         InfContext,
    IN OPTIONAL PCSTR               SourceFile,
    IN OPTIONAL PCSTR               SourcePathRoot,
    IN OPTIONAL PCSTR               DestinationName,
    IN          DWORD               CopyStyle,
    IN OPTIONAL PSP_FILE_CALLBACK_A CopyMsgHandler,
...
SetupInstallFileW(
    IN OPTIONAL HINF                InfHandle,
    IN OPTIONAL PINFCONTEXT         InfContext,
    IN OPTIONAL PCWSTR              SourceFile,
    IN OPTIONAL PCWSTR              SourcePathRoot,
    IN OPTIONAL PCWSTR              DestinationName,
    IN          DWORD               CopyStyle,
    IN OPTIONAL PSP_FILE_CALLBACK_W CopyMsgHandler,
    IN OPTIONAL PVOID               Context
    );
...
SetupSetFileQueueAlternatePlatformA(
    IN          HSPFILEQ             QueueHandle,
    IN OPTIONAL PSP_ALTPLATFORM_INFO AlternatePlatformInfo,
    IN OPTIONAL PCSTR                AlternateDefaultCatalogFile
    );
...
SetupSetFileQueueAlternatePlatformW(
    IN          HSPFILEQ             QueueHandle,
    IN OPTIONAL PSP_ALTPLATFORM_INFO AlternatePlatformInfo,
    IN OPTIONAL PCWSTR               AlternateDefaultCatalogFile
    );
...
SetupQueueCopyA(
    IN          HSPFILEQ QueueHandle,
    IN OPTIONAL PCSTR    SourceRootPath,
    IN OPTIONAL PCSTR    SourcePath,
    IN          PCSTR    SourceFilename,
    IN OPTIONAL PCSTR    SourceDescription,
    IN OPTIONAL PCSTR    SourceTagfile,
    IN          PCSTR    TargetDirectory,
    IN OPTIONAL PCSTR    TargetFilename,
    IN          DWORD    CopyStyle
    );
...
SetupQueueCopyW(
    IN          HSPFILEQ QueueHandle,
    IN OPTIONAL PCWSTR   SourceRootPath,
    IN OPTIONAL PCWSTR   SourcePath,
    IN          PCWSTR   SourceFilename,
    IN OPTIONAL PCWSTR   SourceDescription,
    IN OPTIONAL PCWSTR   SourceTagfile,
    IN          PCWSTR   TargetDirectory,
    IN OPTIONAL PCWSTR   TargetFilename,
    IN          DWORD    CopyStyle
    );
...
SetupQueueCopySectionA(
    ...
    IN          PCSTR    SourceRootPath,
    IN          HINF     InfHandle,
    IN OPTIONAL HINF     ListInfHandle,
    IN          PCSTR    Section,
    IN          DWORD    CopyStyle
    );
...
SetupQueueRenameA(
    IN          HSPFILEQ QueueHandle,
    IN          PCSTR    SourcePath,
    IN OPTIONAL PCSTR    SourceFilename,
    IN OPTIONAL PCSTR    TargetPath,
    IN          PCSTR    TargetFilename
    );
...
SetupQueueRenameW(
    ...
    IN OPTIONAL PCWSTR   SourceFilename,
    IN OPTIONAL PCWSTR   TargetPath,
    IN          PCWSTR   TargetFilename
    );
...
SetupScanFileQueueA(
    ...
    IN OPTIONAL PSP_FILE_CALLBACK_A CallbackRoutine,
...
SetupScanFileQueueW(
    ...
    IN          DWORD               Flags,
    IN OPTIONAL HWND                Window,
    IN OPTIONAL PSP_FILE_CALLBACK_W CallbackRoutine,
    IN OPTIONAL PVOID               CallbackContext,
    OUT         PDWORD              Result
    );
...
SetupCopyOEMInfA(
    ...
    IN OPTIONAL  PCSTR   OEMSourceMediaLocation,
    IN           DWORD   OEMSourceMediaType,
    IN           DWORD   CopyStyle,
    __out_ecount(DestinationInfFileNameSize) __opt PSTR    DestinationInfFileName,
...
SetupCopyOEMInfW(
    ...
    IN  OPTIONAL PCWSTR  OEMSourceMediaLocation,
    IN           DWORD   OEMSourceMediaType,
    IN           DWORD   CopyStyle,
    __out_ecount(DestinationInfFileNameSize) __opt PWSTR   DestinationInfFileName,
    __in         DWORD   DestinationInfFileNameSize,
    __out __opt  PDWORD  RequiredSize,
...
SetupAddInstallSectionToDiskSpaceListA(
    IN          HDSKSPC DiskSpace,
    IN          HINF    InfHandle,
    IN OPTIONAL HINF    LayoutInfHandle,
    IN          PCSTR   SectionName,
    IN          PVOID   Reserved1,
    IN          UINT    Reserved2
    );
...
SetupInitDefaultQueueCallbackEx(
    IN          HWND  OwnerWindow,
    IN OPTIONAL HWND  AlternateProgressWindow,
...
SetupInstallFromInfSectionA(
    ...
    IN          PCSTR               SectionName,
    IN          UINT                Flags,
    IN OPTIONAL HKEY                RelativeKeyRoot,
    IN OPTIONAL PCSTR               SourceRootPath,
    IN OPTIONAL UINT                CopyFlags,
    IN OPTIONAL PSP_FILE_CALLBACK_A MsgHandler,
    IN OPTIONAL PVOID               Context,
...
SetupInstallFromInfSectionW(
    ...
    IN OPTIONAL PCWSTR              SourceRootPath,
    IN OPTIONAL UINT                CopyFlags,
    IN OPTIONAL PSP_FILE_CALLBACK_W MsgHandler,
    IN OPTIONAL PVOID               Context,
    IN OPTIONAL HDEVINFO            DeviceInfoSet,
    IN OPTIONAL PSP_DEVINFO_DATA    DeviceInfoData
    );
...
SetupInitializeFileLogW(
    IN OPTIONAL PCWSTR LogFileName,
    IN          DWORD  Flags
    );
...
SetupLogFileA(
    IN          HSPFILELOG FileLogHandle,
    IN OPTIONAL PCSTR      LogSectionName,
    IN          PCSTR      SourceFilename,
    IN          PCSTR      TargetFilename,
    IN OPTIONAL DWORD      Checksum,
    IN OPTIONAL PCSTR      DiskTagfile,
    IN OPTIONAL PCSTR      DiskDescription,
    IN OPTIONAL PCSTR      OtherInfo,
    IN          DWORD      Flags
    );
...
SetupLogFileW(
    IN          HSPFILELOG FileLogHandle,
    IN OPTIONAL PCWSTR     LogSectionName,
    IN          PCWSTR     SourceFilename,
    IN          PCWSTR     TargetFilename,
    IN OPTIONAL DWORD      Checksum,
    IN OPTIONAL PCWSTR     DiskTagfile,
    IN OPTIONAL PCWSTR     DiskDescription,
    IN OPTIONAL PCWSTR     OtherInfo,
    IN          DWORD      Flags
    );
...
SetupQueryFileLogA(
    ...
    __out_ecount(ReturnBufferSize) __opt PSTR             DataOut,
    __in         DWORD            ReturnBufferSize,
    __out __opt  PDWORD           RequiredSize
    );
...
SetupQueryFileLogW(
    ...
    IN           PCWSTR           TargetFilename,
    IN           SetupFileLogInfo DesiredInfo,
    __out_ecount(ReturnBufferSize) __opt PWSTR            DataOut,
    __in         DWORD            ReturnBufferSize,
    __out __opt  PDWORD           RequiredSize
    );
...
SetupDiOpenDeviceInfoW(
    ...
    IN OPTIONAL  HWND             hwndParent,
    IN           DWORD            OpenFlags,
    __out __opt PSP_DEVINFO_DATA DeviceInfoData
    );
...
SetupDiGetDeviceInstanceIdA(
    ...
    __out_ecount(DeviceInstanceIdSize) __opt PSTR       DeviceInstanceId,
...
SetupDiGetDeviceInstanceIdW(
    IN           HDEVINFO         DeviceInfoSet,
    IN           PSP_DEVINFO_DATA DeviceInfoData,
    __out_ecount(DeviceInstanceIdSize) __opt PWSTR        DeviceInstanceId,
    __in           DWORD            DeviceInstanceIdSize,
    __out __opt PDWORD           RequiredSize
    );
...
SetupDiGetDeviceInterfaceDetailA(
    IN           HDEVINFO                           DeviceInfoSet,
    IN           PSP_DEVICE_INTERFACE_DATA          DeviceInterfaceData,
    __out_bcount(DeviceInterfaceDetailDataSize) __opt PSP_DEVICE_INTERFACE_DETAIL_DATA_A DeviceInterfaceDetailData,
...
SetupDiGetDeviceInterfaceDetailW(
    IN           HDEVINFO                           DeviceInfoSet,
    IN           PSP_DEVICE_INTERFACE_DATA          DeviceInterfaceData,
    __out_bcount(DeviceInterfaceDetailDataSize) __opt PSP_DEVICE_INTERFACE_DETAIL_DATA_W DeviceInterfaceDetailData,
    __in         DWORD                              DeviceInterfaceDetailDataSize,
    __out  __opt PDWORD                             RequiredSize,
    __out  __opt PSP_DEVINFO_DATA                   DeviceInfoData
    );
...
SetupDiBuildDriverInfoList(
    IN              HDEVINFO         DeviceInfoSet,
    IN OUT OPTIONAL PSP_DEVINFO_DATA DeviceInfoData,
    IN              DWORD            DriverType
    );
...
SetupDiSetSelectedDriverA(
    IN              HDEVINFO           DeviceInfoSet,
    IN OPTIONAL     PSP_DEVINFO_DATA   DeviceInfoData,
    IN OUT OPTIONAL PSP_DRVINFO_DATA_A DriverInfoData
    );
...
SetupDiSetSelectedDriverW(
    IN              HDEVINFO           DeviceInfoSet,
    IN OPTIONAL     PSP_DEVINFO_DATA   DeviceInfoData,
    IN OUT OPTIONAL PSP_DRVINFO_DATA_W DriverInfoData
    );
...
SetupDiGetDriverInfoDetailA(
    ...
    __out_bcount(DriverInfoDetailDataSize) __opt PSP_DRVINFO_DETAIL_DATA_A DriverInfoDetailData,
...
SetupDiGetDriverInfoDetailW(
    ...
    __out_bcount(DriverInfoDetailDataSize) __opt PSP_DRVINFO_DETAIL_DATA_W DriverInfoDetailData,
    __in         DWORD                     DriverInfoDetailDataSize,
    __out __opt  PDWORD                    RequiredSize
    );
...
SetupDiBuildClassInfoList(
    IN  DWORD  Flags,
    __out_ecount(ClassGuidListSize) __opt LPGUID ClassGuidList,
...
SetupDiGetHwProfileList(
    ...
    __out        PDWORD RequiredSize,
    __out __opt  PDWORD CurrentlyActiveIndex
    );
...
SetupDiGetDevicePropertyKeys(
    IN           HDEVINFO         DeviceInfoSet,
    IN           PSP_DEVINFO_DATA DeviceInfoData,
    __out_ecount(PropertyKeyCount) __opt PROPERTYKEY *PropertyKeyArray,
    __in         DWORD            PropertyKeyCount,
    __out __opt  PDWORD           RequiredPropertyKeyCount,
    IN           DWORD            Flags
    );
...
SetupDiGetDeviceProperty(
    IN           HDEVINFO         DeviceInfoSet,
    IN           PSP_DEVINFO_DATA DeviceInfoData,
    __in   CONST PROPERTYKEY     *PropertyKey,
    __out        VARTYPE         *PropertyType,
    __out_bcount(PropertyBufferSize) __opt PBYTE PropertyBuffer,
...
SetupDiSetDeviceProperty(
    ...
    IN           PSP_DEVINFO_DATA DeviceInfoData,
    __in   CONST PROPERTYKEY     *PropertyKey,
    __in         VARTYPE          PropertyType,
    __in_bcount(PropertyBufferSize) __opt CONST PBYTE PropertyBuffer,
    __in         DWORD            PropertyBufferSize,
    IN           DWORD            Flags
    );
...
//
// Flags for SetupDiGetClassPropertyKeysEx, SetupDiGetClassPropertyEx, and
// SetupDiSetClassPropertyEx.
//
#define DICLASSPROP_INSTALLER   0x00000000    // device setup class property
#define DICLASSPROP_INTERFACE   0x00000001    // device interface class property
...
BOOL
WINAPI
SetupDiGetClassPropertyKeysExA(
    IN     CONST GUID            *ClassGuid,
    __out_ecount(PropertyKeyCount) __opt PROPERTYKEY *PropertyKeyArray,
    __in         DWORD            PropertyKeyCount,
    __out __opt  PDWORD           RequiredPropertyKeyCount,
...
#else
#define SetupDiGetClassPropertyKeysEx SetupDiGetClassPropertyKeysExA
#endif
...
#else
#define SetupDiGetClassPropertyEx     SetupDiGetClassPropertyExA
#endif
...
#else
#define SetupDiSetClassPropertyEx     SetupDiSetClassPropertyExA
#endif
...
SetupDiGetDeviceRegistryPropertyA(
    ...
    IN           PSP_DEVINFO_DATA DeviceInfoData,
    IN           DWORD            Property,
    __out __opt  PDWORD           PropertyRegDataType,
    __out_bcount(PropertyBufferSize) __opt PBYTE           PropertyBuffer,
    __in         DWORD            PropertyBufferSize,
    __out __opt  PDWORD           RequiredSize
    );
...
SetupDiSetDeviceRegistryPropertyA(
    ...
    IN OUT      PSP_DEVINFO_DATA DeviceInfoData,
    IN          DWORD            Property,
    __in_bcount(PropertyBufferSize) __opt CONST BYTE*      PropertyBuffer,
    __in        DWORD            PropertyBufferSize
    );
...
SetupDiGetClassInstallParamsA(
    IN           HDEVINFO                DeviceInfoSet,
    IN  OPTIONAL PSP_DEVINFO_DATA        DeviceInfoData,
    __out_bcount(ClassInstallParamsSize) __opt PSP_CLASSINSTALL_HEADER ClassInstallParams,
...
SetupDiSetClassInstallParamsA(
    IN          HDEVINFO                DeviceInfoSet,
    __in __opt  PSP_DEVINFO_DATA        DeviceInfoData,
    __in_bcount(ClassInstallParamsSize) __opt PSP_CLASSINSTALL_HEADER ClassInstallParams,
    __in        DWORD                   ClassInstallParamsSize
    );
...
SetupDiGetActualModelsSectionA(
    IN           PINFCONTEXT Context,
    IN  OPTIONAL PSP_ALTPLATFORM_INFO  AlternatePlatformInfo,
    __out_ecount(InfSectionWithExtSize) __opt PSTR    InfSectionWithExt,
...
SetupDiGetActualModelsSectionW(
    IN           PINFCONTEXT Context,
    IN  OPTIONAL PSP_ALTPLATFORM_INFO  AlternatePlatformInfo,
    __out_ecount(InfSectionWithExtSize) __opt PWSTR   InfSectionWithExt,
    __in         DWORD   InfSectionWithExtSize,
    __out __opt  PDWORD  RequiredSize,
    IN           PVOID   Reserved
    );
...
SetupEnumInfSectionsA (
    IN           HINF        InfHandle,
    IN           UINT        Index,
    __out_ecount(Size) __opt PSTR        Buffer,
    __in   UINT        Size,
    __out __opt UINT        *SizeNeeded
    );
...
SetupEnumInfSectionsW (
    IN           HINF        InfHandle,
    IN           UINT        Index,
    __out_ecount(Size) __opt PWSTR       Buffer,
    __in UINT        Size,
    __out __opt UINT        *SizeNeeded
    );
...
SetupVerifyInfFileA(
    IN           PCSTR                   InfName,
    IN  OPTIONAL PSP_ALTPLATFORM_INFO    AltPlatformInfo,
...
DriverStoreAddDriverPackageW(
    IN           PCWSTR   DriverPackageInfPath,
    IN           DWORD    Flags,
    IN           PVOID    Reserved,
    OUT OPTIONAL PWSTR*   IdString,
    OUT OPTIONAL PWSTR*   DestInfPath
    );
...
DriverStoreAddDriverPackageA(
    ...
    IN           DWORD    Flags,
    IN           PVOID    Reserved,
    OUT OPTIONAL PSTR*    IdString,
    OUT OPTIONAL PSTR*    DestInfPath
    );

#ifdef UNICODE
#define DriverStoreAddDriverPackage DriverStoreAddDriverPackageW
#else
#define DriverStoreAddDriverPackage DriverStoreAddDriverPackageA
#endif
...
DriverStoreDeleteDriverPackageA(
    IN PCSTR    DriverPackageId,
    IN DWORD    Flags,
    IN PVOID    Reserved
    );

#ifdef UNICODE
#define DriverStoreDeleteDriverPackage DriverStoreDeleteDriverPackageW
#else
#define DriverStoreDeleteDriverPackage DriverStoreDeleteDriverPackageA
#endif

HRESULT
DriverStoreGetDriverPackageIdW(
    IN              PCWSTR  DriverPackageInfPath,
    __out_ecount(*cchDriverPackageId) __opt PWSTR   DriverPackageId,
    __inout                                 PULONG  cchDriverPackageId
    );

HRESULT
DriverStoreGetDriverPackageIdA(
    IN              PCSTR   DriverPackageInfPath,
    __out_ecount(*cchDriverPackageId) __opt PSTR    DriverPackageId,
    __inout                                 PULONG  cchDriverPackageId
    );

#ifdef UNICODE
#define DriverStoreGetDriverPackageId DriverStoreGetDriverPackageIdW
#else
#define DriverStoreGetDriverPackageId DriverStoreGetDriverPackageIdA
#endif

WINSETUPAPI
HRESULT
WINAPI
DriverStoreExportDriverPackageW(
    IN PCWSTR DriverPackageId,
    IN PCWSTR DriverPackageDestPath,
    IN DWORD  Flags,
    IN PVOID  Reserved
    );
...
HRESULT
WINAPI
DriverStoreExportDriverPackageA(
    IN PCSTR DriverPackageId,
    IN PCSTR DriverPackageDestPath,
    IN DWORD  Flags,
    IN PVOID  Reserved
    );

#ifdef UNICODE
#define DriverStoreExportDriverPackage DriverStoreExportDriverPackageW
#else
#define DriverStoreExportDriverPackage DriverStoreExportDriverPackageA
#endif
