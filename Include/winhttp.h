...
WinHttpStartup(
    ...
    PVOID  lpReserved      // reserved, MUST be NULL
);

WINHTTPAPI
VOID
WINAPI
WinHttpShutdown(VOID);
...
#define ERROR_WINHTTP_PROXY_AUTH_REQUIRED                   (WINHTTP_ERROR_BASE + 185)

#define WINHTTP_ERROR_LAST                                  (WINHTTP_ERROR_BASE + 185)
