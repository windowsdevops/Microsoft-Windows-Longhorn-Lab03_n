...
#define STATIC_KSCOMPONENTID_AVCAUDIO \
    0xc1ca31ed, 0xbe33, 0x4924, 0xa3, 0xf5, 0x53, 0x92, 0x54, 0x31, 0xf1, 0x92
DEFINE_GUIDSTRUCT("C1CA31ED-BE33-4924-A3F5-53925431F192", KSCOMPONENTID_AVCAUDIO);
#define KSCOMPONENTID_AVCAUDIO DEFINE_GUIDNAMED(KSCOMPONENTID_AVCAUDIO)
...
#define KS_AMCONTROL_COLORINFO_PRESENT 0x00000100 // if set, indicates DXVA color info is present in the upper (20) bits of the dwControlFlags
