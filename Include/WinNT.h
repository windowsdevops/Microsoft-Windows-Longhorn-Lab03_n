/*++ BUILD Version: 0116     Increment this if a change has global effects
...
#define REALTIME_OBJECT_FLAG 0x20       
...
//
//  Note that LOCALE_CUSTOM_UNSPECIFIED is not currently used by Windows
//  since custom locales that are not the user default cannot be accessed.
//
...
#define DBG_FORCE_CONTINUE               ((DWORD   )0x00010003L)    
...
#define DOMAIN_ALIAS_RID_IIS_WORKER_USERS       (0x00000232L)

#define DOMAIN_ALIAS_RID_CASTLE_NODES           (0x00000233L)
#define DOMAIN_ALIAS_RID_CASTLE_COMPUTERS       (0x00000234L)
#define DOMAIN_ALIAS_RID_CASTLE_JOINERS         (0x00000235L)
#define DOMAIN_ALIAS_RID_CASTLE_USERS           (0x00000236L)
#define DOMAIN_ALIAS_RID_CASTLE_ADMINS          (0x00000237L)
...
#define SE_RESERVE_PROCESSOR_NAME         TEXT("SeReserveProcessorPrivilege")
...
// These are used by Protected Admin APIs.
//
...
#define THREAD_SET_QUOTA                (THREAD_SET_THREAD_TOKEN)
// begin_wdm 
...
typedef struct _RESERVE_BASIC_INFORMATION {
    DWORD64 Deadline;
    ULONG_PTR Affinity;
    DWORD BackgroundBudget;
    DWORD RemainingBudget;
    DWORD Period;
    DWORD Budget;
    DWORD LateCount;
    DWORD ObjectFlags;
} RESERVE_BASIC_INFORMATION, *PRESERVE_BASIC_INFORMATION;
...
#define IMAGE_SUBSYSTEM_NEXUS_AGENT          15
...
} FOUR_PART_VERSION, *PFOUR_PART_VERSION;

typedef const FOUR_PART_VERSION *PCFOUR_PART_VERSION;
...
#define TRANSACTIONMANAGER_ENLIST                ( 0x0004 )
#define TRANSACTIONMANAGER_COMMIT                ( 0x0008 )
#define TRANSACTIONMANAGER_ROLLBACK              ( 0x0010 )
#define TRANSACTIONMANAGER_PROPAGATE             ( 0x0020 )
#define TRANSACTIONMANAGER_SAVEPOINT             ( 0x0040 )
#define TRANSACTIONMANAGER_MARSHALL              ( TRANSACTIONMANAGER_QUERY_INFORMATION )

//
// Generic mappings for transactionManager rights.
//
...
typedef struct _TP_GANG TP_GANG, *PTP_GANG; 

typedef VOID (NTAPI *PTP_GANG_CANCEL_CALLBACK)(
    IN PVOID ObjectContext,
    IN PVOID CleanupContext
    );
...
typedef struct _TP_CALLBACK_ENVIRON {
    ...
    PTP_POOL                 Pool;
    PTP_GANG                 Gang;
    PTP_GANG_CANCEL_CALLBACK GangCancelCallback;
    PVOID                    RaceDll;
    ...
    )
{
    ...
    CallbackEnviron->Gang = NULL;
    CallbackEnviron->GangCancelCallback = NULL;
...
TpSetCallbackGang(
    IN OUT PTP_CALLBACK_ENVIRON     CallbackEnviron,
    IN     PTP_GANG                 Gang,
    IN     PTP_GANG_CANCEL_CALLBACK GangCancelCallback
    )
{
    CallbackEnviron->Gang = Gang;
    CallbackEnviron->GangCancelCallback = GangCancelCallback;
}
