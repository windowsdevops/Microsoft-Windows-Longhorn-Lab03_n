...
WNetGetConnectionA(
     IN LPCSTR lpLocalName,
     __out_ecount(*lpnLength) LPSTR  lpRemoteName,
     __inout LPDWORD  lpnLength
    );
DWORD APIENTRY
WNetGetConnectionW(
     IN LPCWSTR lpLocalName,
     __out_ecount(*lpnLength) LPWSTR  lpRemoteName,
     __inout LPDWORD  lpnLength
    );
#ifdef UNICODE
...
WNetUseConnectionA(
    ...
    IN LPCSTR        lpUserID,
    IN DWORD           dwFlags,
    __out_ecount(*lpBufferSize) LPSTR        lpAccessName,
...
WNetUseConnectionW(
    ...
    IN LPCWSTR        lpUserID,
    IN DWORD           dwFlags,
    __out_ecount(*lpBufferSize) LPWSTR        lpAccessName,
    __inout LPDWORD     lpBufferSize,
    __out LPDWORD        lpResult
    );
#ifdef UNICODE
...
WNetOpenEnumA(
     ...
     IN DWORD          dwType,
     IN DWORD          dwUsage,
     __in __opt LPNETRESOURCEA lpNetResource,
...
WNetOpenEnumW(
     ...
     IN DWORD          dwType,
     IN DWORD          dwUsage,
     __in __opt LPNETRESOURCEW lpNetResource,
     __out LPHANDLE       lphEnum
    );
#ifdef UNICODE
