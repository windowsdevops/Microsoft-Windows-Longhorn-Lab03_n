...
// !! WARNING !!
//
// all of the exports from xolehlp.dll are __cdecl exports, and have been so since NT4
//
// !! WARNING !!
//
#ifdef _XOLEHLP_
#define XOLEHELPAPI     EXTERN_C HRESULT __cdecl
#else
#define XOLEHELPAPI     EXTERN_C DECLSPEC_IMPORT HRESULT __cdecl
#endif
...
//for it.
//--------------------------------------*/
XOLEHELPAPI DtcGetTransactionManager( 
									/* in */ char * i_pszHost,
									/* in */ char *	i_pszTmName,
									/* in */ REFIID i_riid,
...
XOLEHELPAPI DtcGetTransactionManagerC(
									/* in */ char * i_pszHost,
									/* in */ char *	i_pszTmName,
									/* in */ REFIID i_riid,
									/* in */ DWORD i_dwReserved1,
...
XOLEHELPAPI DtcGetTransactionManagerExA(
									/* in */ char * i_pszHost,
									/* in */ char * i_pszTmName,
									/* in */ REFIID i_riid,
...
XOLEHELPAPI DtcGetTransactionManagerExW(
									/* in */ WCHAR * i_pwszHost,
