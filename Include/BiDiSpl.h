...
HRESULT STDMETHODCALLTYPE IBidiSpl2_BindDevice_Proxy( 
    IBidiSpl2 * This,
    /* [in] */ const LPCWSTR pszDeviceName,
    /* [in] */ const DWORD dwAccess);


void __RPC_STUB IBidiSpl2_BindDevice_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBidiSpl2_UnbindDevice_Proxy( 
    IBidiSpl2 * This);


void __RPC_STUB IBidiSpl2_UnbindDevice_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBidiSpl2_SendRecvXMLString_Proxy( 
    IBidiSpl2 * This,
    /* [in] */ BSTR bstrRequest,
    /* [out] */ BSTR *pbstrResponse);


void __RPC_STUB IBidiSpl2_SendRecvXMLString_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBidiSpl2_SendRecvXMLStream_Proxy( 
    IBidiSpl2 * This,
    /* [in] */ IStream *pSRequest,
    /* [out] */ IStream **ppSResponse);


void __RPC_STUB IBidiSpl2_SendRecvXMLStream_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
