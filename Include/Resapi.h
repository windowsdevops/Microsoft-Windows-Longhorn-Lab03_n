...
ResUtilGetDwordValue(
    ...
    IN OPTIONAL DWORD dwDefaultValue
    );
...
DWORD
WINAPI
ResUtilGetClusterHostedNames(
      HCLUSTER  hClusterIn
    , WCHAR *   pwszNodeNameIn
    , WCHAR **  ppwszHostedNamesOut
    , DWORD *   pcHostedNamesOut
    , DWORD *   pcchHostedNamesOut
    );
    
DWORD
WINAPI
ResUtilGetClusterHostedIPAddresses(
      HCLUSTER  hClusterIn
    , WCHAR *   pwszNodeNameIn
    , WCHAR **  ppwszHostedAddressesOut
    , DWORD *   pcHostedAddressesOut
    , DWORD *   pcchHostedAddressesOut
    );
