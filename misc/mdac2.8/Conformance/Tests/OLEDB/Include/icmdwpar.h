...
} g_rgStdParamBindInfo[] =
{
	...
	L"DBTYPE_DATE",				DBTYPE_DATE,			{ NULL, NULL, 6,	DBPARAMFLAGS_ISSIGNED, (BYTE)~0, (BYTE)~0  },
	L"DBTYPE_DBDATE",			DBTYPE_DBDATE,			{ NULL, NULL, 6,	DBPARAMFLAGS_ISSIGNED, (BYTE)~0, (BYTE)~0  },
	L"DBTYPE_DBTIME",			DBTYPE_DBTIME,			{ NULL, NULL, 6,	DBPARAMFLAGS_ISSIGNED, (BYTE)~0, (BYTE)~0  },
	...
	L"DBTYPE_LONGVARCHAR",		DBTYPE_STR,				{ NULL, NULL, 5000, DBPARAMFLAGS_ISSIGNED, (BYTE)~0, (BYTE)~0  },
	...
	L"DBTYPE_WLONGVARCHAR",		DBTYPE_WSTR,			{ NULL, NULL, 5000, DBPARAMFLAGS_ISSIGNED, (BYTE)~0, (BYTE)~0  },
	...
	L"DBTYPE_LONGVARBINARY",	DBTYPE_BYTES,			{ NULL, NULL, 5000, DBPARAMFLAGS_ISSIGNED, (BYTE)~0, (BYTE)~0  }
};
