...
ColList ProceduresCols[] = 
{
	...
	L"PROCEDURE_DEFINITION",		DBTYPE_WSTR,	0,						NULL,		FALSE,
	L"DESCRIPTION",					DBTYPE_WSTR,	0,						NULL,		TRUE,
...
ColList ViewsCols[] = 
{
	...
	L"CHECK_OPTION",				DBTYPE_BOOL,	NUMELEM(rgBoolList),	rgBoolList,			FALSE,
	L"IS_UPDATABLE",				DBTYPE_BOOL,	NUMELEM(rgBoolList),	rgBoolList,			FALSE,
	L"DESCRIPTION",					DBTYPE_WSTR,	0,						NULL,				TRUE,
	L"DATE_CREATED",				DBTYPE_DATE,	0,						NULL,				TRUE,
	L"DATE_MODIFIED",				DBTYPE_DATE,	0,						NULL,				TRUE,
};
