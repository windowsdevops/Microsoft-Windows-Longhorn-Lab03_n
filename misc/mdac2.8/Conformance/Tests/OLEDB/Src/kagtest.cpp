	...
	for (cIndex=0;cIndex<cArraySize;cIndex++)
	{
		...
		else
		{
			...
			{	
				...
				{
					case VT_I4:
						V_I4(&rgGetDiag[cIndex].vDiagInfo)	= wDiagInfo;
						break;
					case VT_UI4:
						V_UI4(&rgGetDiag[cIndex].vDiagInfo)	= wDiagInfo;
						break;
					case VT_I2:
						V_I2(&rgGetDiag[cIndex].vDiagInfo)	= wDiagInfo;
						break;
					case VT_UI2:
						V_UI2(&rgGetDiag[cIndex].vDiagInfo)	= wDiagInfo;
						break;
				}
				rgGetDiagHR[cIndex]	= S_OK;
			}
					...
					for (i=0;i<m_rgPropSets[0].cProperties;i++)
					{
						if (m_rgPropSets[0].rgProperties[i].dwPropertyID==DBPROP_INIT_DATASOURCE)
						{
							bstrTempD = SysAllocStringLen(	m_rgPropSets[0].rgProperties[i].vValue.bstrVal,
															wcslen(m_rgPropSets[0].rgProperties[i].vValue.bstrVal));
							SysFreeString(m_rgPropSets[0].rgProperties[i].vValue.bstrVal);
							m_rgPropSets[0].rgProperties[i].vValue.bstrVal	= SysAllocStringLen(L"",wcslen(L""));
			...
			switch (eNum)
			{
				case eERRORONE:
					...
					for (i=0;i<m_rgPropSets[0].cProperties;i++)
					{
						...
						{
							SysFreeString(m_rgPropSets[0].rgProperties[i].vValue.bstrVal);
							m_rgPropSets[0].rgProperties[i].vValue.bstrVal = SysAllocStringLen(bstrTempD,wcslen(bstrTempD));
						...
						{
							SysFreeString(m_rgPropSets[0].rgProperties[i].vValue.bstrVal);
							m_rgPropSets[0].rgProperties[i].vValue.bstrVal = SysAllocStringLen(bstrTempU,wcslen(bstrTempU));
						...
						{
							SysFreeString(m_rgPropSets[0].rgProperties[i].vValue.bstrVal);
							m_rgPropSets[0].rgProperties[i].vValue.bstrVal = SysAllocStringLen(bstrTempP,wcslen(bstrTempP));
