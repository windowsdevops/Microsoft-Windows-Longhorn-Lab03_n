...
public:
	...
	BOOL CScalar::CheckStr(int iPrec, WCHAR *wszBuf,WCHAR *wszExpBuf, int compType);
...
{								   
	...
	if (g_ProvInfo.dwDBMSType == DRVR_SQLSRVR && g_ProvInfo.ulVersion >= 7)
		return CheckQry(L"Jan 15 1995 12:00AM",CHECKSTR);
