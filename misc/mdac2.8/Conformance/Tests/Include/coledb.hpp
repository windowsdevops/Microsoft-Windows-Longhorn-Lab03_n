...
//
//--------------------------------------------------------------------
class DLL_EXPORT COLEDB : public CTestCases
{
	// @access public
public:
...
//
//--------------------------------------------------------------------
class DLL_EXPORT CDataSourceObject : public COLEDB
{
	// @access	public
	public:
...
//
//--------------------------------------------------------------------
class DLL_EXPORT CSessionObject : public CDataSourceObject
{
	// @access public
	public:
...
//
//--------------------------------------------------------------------
class DLL_EXPORT CCommandObject : public CSessionObject 
{
	// @access public
	public:
...
//
//--------------------------------------------------------------------
class DLL_EXPORT CRowsetObject : public CCommandObject
{
	// @access public
	public:
