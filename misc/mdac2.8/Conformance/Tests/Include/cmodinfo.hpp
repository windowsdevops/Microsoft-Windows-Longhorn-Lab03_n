...
public:
	...
	virtual BOOL  GetInitPropsXMLOLEDB(ULONG*	pcPropSets, DBPROPSET**	prgPropSets);
...
//
///////////////////////////////////////////////////////////////////
DLL_EXPORT	HRESULT		DisplayPooling(IUnknown* pDataSource, BOOL fEnumPools = FALSE);
DLL_EXPORT	DWORD		GetPoolState(IUnknown* pDataSource);
DLL_EXPORT	BOOL		DrawnFromPool(IUnknown* pDataSource);
DLL_EXPORT	BOOL		CanBePooled(IUnknown* pDataSource);
DLL_EXPORT	BOOL		CreatedFromPool(IUnknown* pDataSource);
