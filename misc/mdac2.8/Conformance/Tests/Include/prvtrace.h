...
DLL_EXPORT INT MessageBox(HWND hwnd, UINT uiStyle, CHAR* pszTitle, CHAR* pszFmt, ...);
DLL_EXPORT void InternalTrace(const CHAR* pszExp, ...);
DLL_EXPORT void InternalTrace(const WCHAR* pwszExp, ...);
